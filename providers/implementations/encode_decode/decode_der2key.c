...
typedef void *key_from_pkcs8_t(const PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx,
                               const char *propq);
static void *
der2key_decode_p8(const unsigned char **input_der, long input_der_len, struct der2key_ctx_st *ctx,
...
der2key_settable_ctx_params(ossl_unused void *provctx)
{
    static const OSSL_PARAM settables[] = {
        OSSL_PARAM_utf8_string(OSSL_DECODER_PARAM_PROPERTIES, NULL, 0), OSSL_PARAM_END};
    return settables;
}

static int
der2key_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
...
static int
der2key_decode(void *vctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *data_cb,
...
static void *
dh_d2i_PKCS8(const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
...
static void
dh_adjust(void *key, struct der2key_ctx_st *ctx)
{
...
static void *
dsa_d2i_PKCS8(const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
...
static void
dsa_adjust(void *key, struct der2key_ctx_st *ctx)
{
...
static void *
ec_d2i_PKCS8(const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
...
static int
ec_check(void *key, struct der2key_ctx_st *ctx)
{
    ...
    if (sm2)
        ret =
            ctx->desc->evp_type == EVP_PKEY_SM2 || ctx->desc->evp_type == NID_X9_62_id_ecPublicKey;
    else
...
static void
ec_adjust(void *key, struct der2key_ctx_st *ctx)
{
...
static void *
ecx_d2i_PKCS8(const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
...
static void
ecx_key_adjust(void *key, struct der2key_ctx_st *ctx)
{
...
static void *
sm2_d2i_PKCS8(const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
    return der2key_decode_p8(der, der_len, ctx, (key_from_pkcs8_t *)ossl_ec_key_from_pkcs8);
}
# endif
...
ml_kem_d2i_PUBKEY(const uint8_t **der, long der_len, struct der2key_ctx_st *ctx)
{
    ML_KEM_KEY *key;
...
static ossl_inline void *
slh_dsa_d2i_PUBKEY(const uint8_t **der, long der_len, struct der2key_ctx_st *ctx)
{
    int ok = 0;
    OSSL_LIB_CTX *libctx = PROV_LIBCTX_OF(ctx->provctx);
    ...
    if (der_len != 18 + (long)len) {
        ERR_raise_data(ERR_LIB_PROV, PROV_R_BAD_ENCODING,
                       "unexpected %s public key length: %ld != %ld", ctx->desc->keytype_name,
                       der_len, 18 + (long)len);
        goto err;
    }
    ...
    if (ASN1_item_d2i_ex((ASN1_VALUE **)&spki, &end, der_len, ASN1_ITEM_rptr(BARE_PUBKEY), NULL,
                         NULL) == NULL) {
...
static void *
rsa_d2i_PKCS8(const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
{
    return der2key_decode_p8(der, der_len, ctx, (key_from_pkcs8_t *)ossl_rsa_key_from_pkcs8);
}

static void *
rsa_d2i_PUBKEY(const unsigned char **der, long der_len, ossl_unused struct der2key_ctx_st *ctx)
{
    return d2i_RSA_PUBKEY(NULL, der, der_len);
}

static int
rsa_check(void *key, struct der2key_ctx_st *ctx)
{
    int valid;
...
static void
rsa_adjust(void *key, struct der2key_ctx_st *ctx)
{
...
static ossl_inline void *
ml_dsa_d2i_PUBKEY(const uint8_t **der, long der_len, struct der2key_ctx_st *ctx)
{
    ML_DSA_KEY *key;
...
#define DO_type_specific_keypair(keytype)                                                          \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_KEYPAIR), keytype##_d2i_private_key, \
        keytype##_d2i_public_key, NULL, NULL, NULL, keytype##_check, keytype##_adjust,             \
        keytype##_free
...
#define DO_type_specific_priv(keytype)                                                             \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY),                        \
        keytype##_d2i_private_key, NULL, NULL, NULL, NULL, keytype##_check, keytype##_adjust,      \
        keytype##_free

#define DO_type_specific_params(keytype)                                                           \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), NULL, NULL,         \
        keytype##_d2i_key_params, NULL, NULL, keytype##_check, keytype##_adjust, keytype##_free

#define DO_type_specific(keytype)                                                                  \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL), keytype##_d2i_private_key,     \
        keytype##_d2i_public_key, keytype##_d2i_key_params, NULL, NULL, keytype##_check,           \
...
#define DO_type_specific_no_pub(keytype)                                                           \
    "type-specific", keytype##_evp_type,                                                           \
        ...
        keytype##_d2i_private_key, NULL, keytype##_d2i_key_params, NULL, NULL, keytype##_check,    \
        keytype##_adjust, keytype##_free

#define DO_PrivateKeyInfo(keytype)                                                                 \
    "PrivateKeyInfo", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY), NULL, NULL, NULL,     \
        keytype##_d2i_PKCS8, NULL, keytype##_check, keytype##_adjust, keytype##_free

#define DO_SubjectPublicKeyInfo(keytype)                                                           \
    "SubjectPublicKeyInfo", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PUBLIC_KEY), NULL, NULL,      \
        NULL, NULL, keytype##_d2i_PUBKEY, keytype##_check, keytype##_adjust, keytype##_free
...
#define DO_DSA(keytype)                                                                            \
    "DSA", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL), keytype##_d2i_private_key,               \
        keytype##_d2i_public_key, keytype##_d2i_key_params, NULL, NULL, keytype##_check,           \
        keytype##_adjust, keytype##_free
...
#define DO_RSA(keytype)                                                                            \
    "RSA", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_KEYPAIR), keytype##_d2i_private_key,           \
        keytype##_d2i_public_key, NULL, NULL, NULL, keytype##_check, keytype##_adjust,             \
        keytype##_free
...
#define MAKE_DECODER(keytype_name, keytype, type, kind)                                            \
    ...
    const OSSL_DISPATCH ossl_##kind##_der_to_##keytype##_decoder_functions[] = {                   \
        ...
        {OSSL_FUNC_DECODER_SETTABLE_CTX_PARAMS, (void (*)(void))der2key_settable_ctx_params},      \
