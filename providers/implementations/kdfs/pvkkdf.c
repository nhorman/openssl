...
static int
pvk_set_membuf(unsigned char **buffer, size_t *buflen, const OSSL_PARAM *p)
{
...
static int
kdf_pvk_derive(void *vctx, unsigned char *key, size_t keylen, const OSSL_PARAM params[])
{
    KDF_PVK *ctx = (KDF_PVK *)vctx;
    const EVP_MD *md;
    EVP_MD_CTX *mctx;
...
static int
kdf_pvk_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    const OSSL_PARAM *p;
    KDF_PVK *ctx = vctx;
    OSSL_LIB_CTX *provctx = PROV_LIBCTX_OF(ctx->provctx);
...
kdf_pvk_settable_ctx_params(ossl_unused void *ctx, ossl_unused void *p_ctx)
{
...
static int
kdf_pvk_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    OSSL_PARAM *p;
...
static const OSSL_PARAM *
kdf_pvk_gettable_ctx_params(ossl_unused void *ctx, ossl_unused void *p_ctx)
{
