...
static void *
slh_dsa_newctx(void *provctx, const char *alg, const char *propq)
{
...
static int
slh_dsa_set_alg_id_buffer(PROV_SLH_DSA_CTX *ctx)
{
    int ret;
    WPACKET pkt;
    uint8_t *aid = NULL;
...
static int
slh_dsa_signverify_msg_init(void *vctx, void *vkey, const OSSL_PARAM params[], int operation,
                            const char *desc)
{
    PROV_SLH_DSA_CTX *ctx = (PROV_SLH_DSA_CTX *)vctx;
...
static int
slh_dsa_sign_msg_init(void *vctx, void *vkey, const OSSL_PARAM params[])
{
    return slh_dsa_signverify_msg_init(vctx, vkey, params, EVP_PKEY_OP_SIGN, "SLH_DSA Sign Init");
}

static int
slh_dsa_digest_signverify_init(void *vctx, const char *mdname, void *vkey,
...
static int
slh_dsa_sign(void *vctx, unsigned char *sig, size_t *siglen, size_t sigsize,
             const unsigned char *msg, size_t msg_len)
{
    ...
    ret =
        ossl_slh_dsa_sign(ctx->hash_ctx, msg, msg_len, ctx->context_string, ctx->context_string_len,
                          opt_rand, ctx->msg_encode, sig, siglen, sigsize);
...
static int
slh_dsa_digest_sign(void *vctx, uint8_t *sig, size_t *siglen, size_t sigsize, const uint8_t *tbs,
                    size_t tbslen)
{
...
static int
slh_dsa_verify_msg_init(void *vctx, void *vkey, const OSSL_PARAM params[])
{
...
static int
slh_dsa_verify(void *vctx, const uint8_t *sig, size_t siglen, const uint8_t *msg, size_t msg_len)
{
    PROV_SLH_DSA_CTX *ctx = (PROV_SLH_DSA_CTX *)vctx;
...
static int
slh_dsa_digest_verify(void *vctx, const uint8_t *sig, size_t siglen, const uint8_t *tbs,
                      size_t tbslen)
{
...
static int
slh_dsa_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
...
static int
slh_dsa_get_ctx_params(void *vctx, OSSL_PARAM *params)
{
    PROV_SLH_DSA_CTX *ctx = (PROV_SLH_DSA_CTX *)vctx;
    OSSL_PARAM *p;
...
#define MAKE_SIGNATURE_FUNCTIONS(alg, fn)                                                          \
    ...
    const OSSL_DISPATCH ossl_slh_dsa_##fn##_signature_functions[] = {                              \
        ...
        {OSSL_FUNC_SIGNATURE_SIGN_MESSAGE_INIT, (void (*)(void))slh_dsa_sign_msg_init},            \
        {OSSL_FUNC_SIGNATURE_SIGN, (void (*)(void))slh_dsa_sign},                                  \
        {OSSL_FUNC_SIGNATURE_VERIFY_MESSAGE_INIT, (void (*)(void))slh_dsa_verify_msg_init},        \
        {OSSL_FUNC_SIGNATURE_VERIFY, (void (*)(void))slh_dsa_verify},                              \
        {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_INIT, (void (*)(void))slh_dsa_digest_signverify_init},    \
        {OSSL_FUNC_SIGNATURE_DIGEST_SIGN, (void (*)(void))slh_dsa_digest_sign},                    \
        {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_INIT, (void (*)(void))slh_dsa_digest_signverify_init},  \
        ...
        {OSSL_FUNC_SIGNATURE_SETTABLE_CTX_PARAMS, (void (*)(void))slh_dsa_settable_ctx_params},    \
        {OSSL_FUNC_SIGNATURE_GET_CTX_PARAMS, (void (*)(void))slh_dsa_get_ctx_params},              \
        {OSSL_FUNC_SIGNATURE_GETTABLE_CTX_PARAMS, (void (*)(void))slh_dsa_gettable_ctx_params},    \
        OSSL_DISPATCH_END}
