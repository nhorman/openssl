...
typedef size_t (*aeswrap_fn)(void *key, const unsigned char *iv, unsigned char *out,
...
static void *
aes_wrap_newctx(size_t kbits, size_t blkbits, size_t ivbits, unsigned int mode, uint64_t flags)
{
...
static int
aes_wrap_init(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv,
...
static int
aes_wrap_einit(void *ctx, const unsigned char *key, size_t keylen, const unsigned char *iv,
...
static int
aes_wrap_dinit(void *ctx, const unsigned char *key, size_t keylen, const unsigned char *iv,
               size_t ivlen, const OSSL_PARAM params[])
{
...
static int
aes_wrap_cipher_internal(void *vctx, unsigned char *out, const unsigned char *in, size_t inlen)
{
    PROV_CIPHER_CTX *ctx = (PROV_CIPHER_CTX *)vctx;
    PROV_AES_WRAP_CTX *wctx = (PROV_AES_WRAP_CTX *)vctx;
    size_t rv;
