...
#define IMPLEMENT_cipher(alg, lc, UCMODE, flags, kbits, blkbits, ivbits)                                \
        static OSSL_FUNC_cipher_newctx_fn ossl_ ## alg ## kbits ## _ ## lc ## \
        _newctx;                       \
        static OSSL_FUNC_cipher_freectx_fn ossl_ ## alg ## _ ## lc ## _freectx;                             \
        static OSSL_FUNC_cipher_dupctx_fn ossl_ ## alg ## _ ## lc ## _dupctx;                              \
        static OSSL_FUNC_cipher_encrypt_init_fn ossl_ ## alg ## _ ## lc ## \
        _einit;                               \
        static OSSL_FUNC_cipher_decrypt_init_fn ossl_ ## alg ## _ ## lc ## \
        _dinit;                               \
        static OSSL_FUNC_cipher_update_fn ossl_ ## alg ## _ ## lc ## \
        _stream_update;                       \
        static OSSL_FUNC_cipher_final_fn ossl_ ## alg ## _ ## lc ## \
        _stream_final;                        \
        static OSSL_FUNC_cipher_cipher_fn ossl_ ## alg ## _ ## lc ## _cipher;                              \
        static OSSL_FUNC_cipher_get_params_fn ossl_ ## alg ## _ ## kbits ## _ ## \
        lc ## _get_params;                \
        static OSSL_FUNC_cipher_get_ctx_params_fn ossl_ ## alg ## _ ## lc ## \
        _get_ctx_params;                      \
        static OSSL_FUNC_cipher_gettable_ctx_params_fn ossl_ ## alg ## _ ## lc \
        ## _gettable_ctx_params;                 \
        static OSSL_FUNC_cipher_set_ctx_params_fn ossl_ ## alg ## _ ## lc ## \
        _set_ctx_params;                      \
        static OSSL_FUNC_cipher_settable_ctx_params_fn ossl_ ## alg ## _ ## lc \
        ## _settable_ctx_params;                 \
        ...
        const OSSL_DISPATCH ossl_ ## alg ## kbits ## lc ## _functions[] = {                                             \
            ...
            { OSSL_FUNC_CIPHER_GET_PARAMS, \
              (void (*)(void)) ossl_ ## alg ## _ ## kbits ## _ ## lc ## \
              _get_params }, \
