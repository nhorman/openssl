...
static int
cipher_hw_rc2_initkey(PROV_CIPHER_CTX *ctx, const unsigned char *key, size_t keylen)
{
...
#define PROV_CIPHER_HW_rc2_mode(mode, UCMODE)                                                      \
    ...
    const PROV_CIPHER_HW *ossl_prov_cipher_hw_rc2_##mode(size_t keybits) { return &rc2_##mode; }
