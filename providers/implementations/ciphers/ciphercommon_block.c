 ...
 */
int
ossl_cipher_tlsunpadblock(OSSL_LIB_CTX *libctx, unsigned int tlsversion, unsigned char *buf,
                          size_t *buflen, size_t blocksize, unsigned char **mac, int *alloced,
                          size_t macsize, int aead)
{
    ...
    switch (tlsversion) {
    case SSL3_VERSION:
        return ssl3_cbc_remove_padding_and_mac(buflen, *buflen, buf, mac, alloced, blocksize,
                                               macsize, libctx);
    ...
    case DTLS1_BAD_VER:
        ...
        *buflen -= blocksize;
        /* Fall through */
    case TLS1_VERSION:
        ret = tls1_cbc_remove_padding_and_mac(buflen, *buflen, buf, mac, alloced, blocksize,
                                              macsize, aead, libctx);
        return ret;
