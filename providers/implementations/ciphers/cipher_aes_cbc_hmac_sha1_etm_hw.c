...
int asm_aescbc_sha1_hmac(const uint8_t *csrc, uint8_t *cdst, uint64_t clen, uint8_t *dsrc,
...
static int
aes_cbc_hmac_sha1_init_key(PROV_CIPHER_CTX *vctx, const unsigned char *key, size_t keylen)
{
    int ret;
...
static int
hwaes_cbc_hmac_sha1_etm(PROV_CIPHER_CTX *vctx, unsigned char *out, const unsigned char *in,
                        size_t len)
{
    PROV_AES_HMAC_SHA_ETM_CTX *ctx = (PROV_AES_HMAC_SHA_ETM_CTX *)vctx;
    CIPH_DIGEST arg = {0};
...
static int
aes_cbc_hmac_sha1_cipher(PROV_CIPHER_CTX *vctx, unsigned char *out, const unsigned char *in,
                         size_t len)
{
