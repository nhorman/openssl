...
static int
cipher_hw_idea_initkey(PROV_CIPHER_CTX *ctx, const unsigned char *key, size_t keylen)
{
...
#define PROV_CIPHER_HW_idea_mode_ex(mode, UCMODE, fname)                                           \
    ...
    const PROV_CIPHER_HW *ossl_prov_cipher_hw_idea_##mode(size_t keybits) { return &idea_##mode; }
