...
chacha20_poly1305_newctx(void *provctx)
{
    ...
    if (ctx != NULL) {
        ossl_cipher_generic_initkey(
            ...
            CHACHA20_POLY1305_IVLEN * 8, CHACHA20_POLY1305_MODE, CHACHA20_POLY1305_FLAGS,
...
chacha20_poly1305_gettable_ctx_params(ossl_unused void *cctx, ossl_unused void *provctx)
{
...
static const OSSL_PARAM chacha20_poly1305_known_settable_ctx_params[] = {
    ...
    OSSL_PARAM_END};
static const OSSL_PARAM *
chacha20_poly1305_settable_ctx_params(ossl_unused void *cctx, ossl_unused void *provctx)
{
    return chacha20_poly1305_known_settable_ctx_params;
}

static int
chacha20_poly1305_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    const OSSL_PARAM *p;
    size_t len;
    PROV_CHACHA20_POLY1305_CTX *ctx = (PROV_CHACHA20_POLY1305_CTX *)vctx;
...
static int
chacha20_poly1305_einit(void *vctx, const unsigned char *key, size_t keylen,
...
static int
chacha20_poly1305_dinit(void *vctx, const unsigned char *key, size_t keylen,
                        const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[])
{
    int ret;
...
static int
chacha20_poly1305_cipher(void *vctx, unsigned char *out, size_t *outl, size_t outsize,
...
static int
chacha20_poly1305_final(void *vctx, unsigned char *out, size_t *outl, size_t outsize)
{
    PROV_CIPHER_CTX *ctx = (PROV_CIPHER_CTX *)vctx;
    PROV_CIPHER_HW_CHACHA20_POLY1305 *hw = (PROV_CIPHER_HW_CHACHA20_POLY1305 *)ctx->hw;
...
const OSSL_DISPATCH ossl_chacha20_ossl_poly1305_functions[] = {
    ...
    {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))chacha20_poly1305_settable_ctx_params},
    OSSL_DISPATCH_END};
