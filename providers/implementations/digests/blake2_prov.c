...
#define IMPLEMENT_BLAKE_functions(variant, VARIANT, variantsize)                                   \
    static const OSSL_PARAM known_blake##variant##_ctx_params[] = {                                \
        {OSSL_DIGEST_PARAM_SIZE, OSSL_PARAM_UNSIGNED_INTEGER, NULL, 0, 0}, OSSL_PARAM_END};        \
                                                                                                   \
    ...
    {                                                                                              \
        ...
        if (p != NULL && !OSSL_PARAM_set_uint(p, (unsigned int)mdctx->params.digest_length)) {     \
    ...
    {                                                                                              \
        ...
        *outctx = *inctx;                                                                          \
                                                                                                   ...
                                                                                                   \
    static int blake##variantsize##_internal_final(void *ctx, unsigned char *out, size_t *outl,    \
                                                   size_t outsz)                                   \
    {                                                                                              \
    ...
    const OSSL_DISPATCH ossl_blake##variantsize##_functions[] = {                                  \
        ...
        {OSSL_FUNC_DIGEST_GET_CTX_PARAMS, (void (*)(void))ossl_blake##variant##_get_ctx_params},   \
        {OSSL_FUNC_DIGEST_SET_CTX_PARAMS, (void (*)(void))ossl_blake##variant##_set_ctx_params},   \
        {0, NULL}};
