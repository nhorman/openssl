...
#define IMPLEMENT_BLAKE_functions(variant, VARIANT, variantsize) \
 ...
 \
            ...
            if (p != NULL) { \
                ...
                ossl_blake ## variant ## _param_set_digest_length( \
 ...
 \
        ...
        static OSSL_FUNC_digest_get_params_fn blake ## variantsize ## \
        _get_params; \
 \
 ...
 \
        static int blake ## variantsize ## _internal_final(void *ctx, \
                                                           unsigned char *out, \
                                                           size_t *outl, \
                                                           size_t outsz) \
        { \
