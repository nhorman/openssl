...
static int
keccak_init(void *vctx, ossl_unused const OSSL_PARAM params[])
{
...
static int
keccak_init_params(void *vctx, const OSSL_PARAM params[])
{
    return keccak_init(vctx, NULL) && shake_set_ctx_params(vctx, params);
}

static int
keccak_update(void *vctx, const unsigned char *inp, size_t len)
{
...
static int
keccak_final(void *vctx, unsigned char *out, size_t *outl, size_t outlen)
{
    int ret = 1;
    KECCAK1600_CTX *ctx = vctx;
...
static int
shake_squeeze(void *vctx, unsigned char *out, size_t *outl, size_t outlen)
{
    int ret = 1;
    KECCAK1600_CTX *ctx = vctx;
 ...
 */
static size_t
generic_sha3_absorb(void *vctx, const void *inp, size_t len)
{
    KECCAK1600_CTX *ctx = vctx;
...
static int
generic_sha3_final(void *vctx, unsigned char *out, size_t outlen)
{
    return ossl_sha3_final((KECCAK1600_CTX *)vctx, out, outlen);
}

static int
generic_sha3_squeeze(void *vctx, unsigned char *out, size_t outlen)
{
...
static PROV_SHA3_METHOD shake_generic_md = {generic_sha3_absorb, generic_sha3_final,
 ...
 */
static size_t
s390x_sha3_absorb(void *vctx, const void *inp, size_t len)
{
    KECCAK1600_CTX *ctx = vctx;
...
static int
s390x_sha3_final(void *vctx, unsigned char *out, size_t outlen)
{
    KECCAK1600_CTX *ctx = vctx;
    unsigned int fc;
...
static int
s390x_shake_final(void *vctx, unsigned char *out, size_t outlen)
{
    KECCAK1600_CTX *ctx = vctx;
    unsigned int fc;
...
static int
s390x_shake_squeeze(void *vctx, unsigned char *out, size_t outlen)
{
    KECCAK1600_CTX *ctx = vctx;
    unsigned int fc;
    size_t len;
...
static int
s390x_keccakc_final(void *vctx, unsigned char *out, size_t outlen, int padding)
{
    KECCAK1600_CTX *ctx = vctx;
...
static int
s390x_keccak_final(void *vctx, unsigned char *out, size_t outlen)
{
    return s390x_keccakc_final(vctx, out, outlen, 0x01);
}

static int
s390x_kmac_final(void *vctx, unsigned char *out, size_t outlen)
{
    return s390x_keccakc_final(vctx, out, outlen, 0x04);
}

static int
s390x_keccakc_squeeze(void *vctx, unsigned char *out, size_t outlen, int padding)
{
    KECCAK1600_CTX *ctx = vctx;
    size_t len;
    unsigned int fc;
...
static int
s390x_keccak_squeeze(void *vctx, unsigned char *out, size_t outlen)
{
    return s390x_keccakc_squeeze(vctx, out, outlen, 0x01);
}

static int
s390x_kmac_squeeze(void *vctx, unsigned char *out, size_t outlen)
{
 ...
 */
static size_t
armsha3_sha3_absorb(void *vctx, const void *inp, size_t len)
{
    KECCAK1600_CTX *ctx = vctx;
...
#define PROV_FUNC_SHAKE_DIGEST(name, bitlen, blksize, dgstsize, flags)                             \
    PROV_FUNC_SHA3_DIGEST_COMMON(name, bitlen, blksize, dgstsize, flags),                          \
        ...
        {OSSL_FUNC_DIGEST_SETTABLE_CTX_PARAMS, (void (*)(void))shake_settable_ctx_params},         \
        {OSSL_FUNC_DIGEST_GET_CTX_PARAMS, (void (*)(void))shake_get_ctx_params},                   \
        {OSSL_FUNC_DIGEST_GETTABLE_CTX_PARAMS, (void (*)(void))shake_gettable_ctx_params},         \
        PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_END

static void
keccak_freectx(void *vctx)
{
...
static void
keccak_copyctx(void *voutctx, void *vinctx)
{
...
shake_gettable_ctx_params(ossl_unused void *ctx, ossl_unused void *provctx)
{
...
static int
shake_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    OSSL_PARAM *p;
    KECCAK1600_CTX *ctx = (KECCAK1600_CTX *)vctx;
...
static const OSSL_PARAM *
shake_settable_ctx_params(ossl_unused void *ctx, ossl_unused void *provctx)
{
...
static int
shake_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    const OSSL_PARAM *p;
    KECCAK1600_CTX *ctx = (KECCAK1600_CTX *)vctx;
...
#define IMPLEMENT_SHA3_functions(bitlen)                                                           \
    SHA3_newctx(sha3, SHA3_##bitlen, sha3_##bitlen, bitlen, '\x06') PROV_FUNC_SHA3_DIGEST(         \
        sha3_##bitlen, bitlen, SHA3_BLOCKSIZE(bitlen), SHA3_MDSIZE(bitlen), SHA3_FLAGS)

#define IMPLEMENT_KECCAK_functions(bitlen)                                                         \
    SHA3_newctx(keccak, KECCAK_##bitlen, keccak_##bitlen, bitlen, '\x01') PROV_FUNC_SHA3_DIGEST(   \
        keccak_##bitlen, bitlen, SHA3_BLOCKSIZE(bitlen), SHA3_MDSIZE(bitlen), SHA3_FLAGS)

#define IMPLEMENT_SHAKE_functions(bitlen)                                                          \
    SHAKE_newctx(shake, SHAKE_##bitlen, shake_##bitlen, bitlen, 0 /* no default md length */,      \
                 '\x1f')                                                                           \
        PROV_FUNC_SHAKE_DIGEST(shake_##bitlen, bitlen, SHA3_BLOCKSIZE(bitlen), 0, SHAKE_FLAGS)

#define IMPLEMENT_KMAC_functions(bitlen)                                                           \
    KMAC_newctx(keccak_kmac_##bitlen, bitlen, '\x04') PROV_FUNC_SHAKE_DIGEST(                      \
        keccak_kmac_##bitlen, bitlen, SHA3_BLOCKSIZE(bitlen), KMAC_MDSIZE(bitlen), KMAC_FLAGS)
