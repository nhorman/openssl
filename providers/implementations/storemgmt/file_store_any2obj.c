...
static void
any2obj_freectx(void *ctx)
{
    OPENSSL_free(ctx);
}

static int
any2obj_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
...
any2obj_settable_ctx_params(ossl_unused void *provctx)
{
    static const OSSL_PARAM settables[] = {
        OSSL_PARAM_utf8_string(OSSL_OBJECT_PARAM_DATA_STRUCTURE, NULL, 0), OSSL_PARAM_END};
    return settables;
}

static int
any2obj_decode_final(void *vctx, int objtype, const char *input_type, const char *data_type,
                     BUF_MEM *mem, OSSL_CALLBACK *data_cb, void *data_cbarg)
{
    struct any2obj_ctx_st *ctx = vctx;
    /*
...
static int
der2obj_decode(void *vctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *data_cb,
...
static int
msblob2obj_decode(void *vctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *data_cb,
                  void *data_cbarg, OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
    struct any2obj_ctx_st *ctx = vctx;
    BIO *in = ossl_bio_new_from_core_bio(ctx->provctx, cin);
...
next:
    ...
    /* any2obj_decode_final() frees |mem| for us */
    return any2obj_decode_final(ctx, OSSL_OBJECT_PKEY, "msblob", isdss ? "DSA" : "RSA", mem,
                                data_cb, data_cbarg);
...
static int
pvk2obj_decode(void *vctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *data_cb,
               void *data_cbarg, OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
    struct any2obj_ctx_st *ctx = vctx;
    BIO *in = ossl_bio_new_from_core_bio(ctx->provctx, cin);
...
next:
    ...
    /* any2obj_decode_final() frees |mem| for us */
    return any2obj_decode_final(ctx, OSSL_OBJECT_PKEY, "pvk", ok ? (isdss ? "DSA" : "RSA") : NULL,
...
#define MAKE_DECODER(fromtype, objtype)                                                            \
    static const OSSL_DISPATCH fromtype##_to_obj_decoder_functions[] = {                           \
        ...
        {OSSL_FUNC_DECODER_SETTABLE_CTX_PARAMS, (void (*)(void))any2obj_settable_ctx_params},      \
