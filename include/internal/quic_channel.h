 ...
 */
int ossl_quic_channel_schedule_new_token(QUIC_CHANNEL *ch, const unsigned char *token,
                                         size_t token_len);
 ...
 * error.
 */
void ossl_quic_channel_raise_protocol_error_loc(QUIC_CHANNEL *ch, uint64_t error_code,
                                                uint64_t frame_type, const char *reason,
                                                ERR_STATE *err_state, const char *src_file,
                                                int src_line, const char *src_func);

# define ossl_quic_channel_raise_protocol_error(ch, error_code, frame_type, reason)                \
     ossl_quic_channel_raise_protocol_error_loc((ch), (error_code), (frame_type), (reason), NULL,  \
...
# define ossl_quic_channel_raise_protocol_error_state(ch, error_code, frame_type, reason, state)   \
     ossl_quic_channel_raise_protocol_error_loc((ch), (error_code), (frame_type), (reason),        \
                                                (state), OPENSSL_FILE, OPENSSL_LINE, OPENSSL_FUNC)
...
int ossl_quic_channel_on_new_conn(QUIC_CHANNEL *ch, const BIO_ADDR *peer,
                                  const QUIC_CONN_ID *peer_scid, const QUIC_CONN_ID *peer_dcid);
...
void ossl_quic_channel_set_msg_callback(QUIC_CHANNEL *ch, ossl_msg_cb msg_callback,
...
int ossl_quic_bind_channel(QUIC_CHANNEL *ch, const BIO_ADDR *peer, const QUIC_CONN_ID *scid,
