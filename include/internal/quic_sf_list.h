 ...
 */
int ossl_sframe_list_insert(SFRAME_LIST *fl, UINT_RANGE *range, OSSL_QRX_PKT *pkt,
 ...
 */
int ossl_sframe_list_lock_head(SFRAME_LIST *fl, UINT_RANGE *range, const unsigned char **data,
                               int *fin);
 ...
 */
typedef int(sframe_list_write_at_cb)(uint64_t logical_offset, const unsigned char *buf,
