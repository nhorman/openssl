...
#define IMPLEMENT_HT_VALUE_TYPE_FNS(vtype, name, pfx)                                              \
    ...
    pfx ossl_unused int ossl_ht_##name##_##vtype##_insert(HT *h, HT_KEY *key, vtype *data,         \
                                                          vtype **olddata)                         \
    {                                                                                              \
        HT_VALUE inval;                                                                            \
        HT_VALUE *oval = NULL;                                                                     \
    ...
    {                                                                                              \
        ...
        return (vtype *)v->value;                                                                  \
                                                                                                   ...
                                                                                                   \
    pfx ossl_unused vtype *ossl_unused ossl_ht_##name##_##vtype##_get(HT *h, HT_KEY *key,          \
                                                                      HT_VALUE **v)                \
    {                                                                                              \
        HT_VALUE *vv;                                                                              \
 ...
 */
HT_VALUE_LIST *ossl_ht_filter(HT *htable, size_t max_len, int (*filter)(HT_VALUE *obj, void *arg),
                              void *arg);
/*
