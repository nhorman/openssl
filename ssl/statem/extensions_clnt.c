...
EXT_RETURN
tls_construct_ctos_renegotiate(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                               size_t chainidx)
{
    if (!s->renegotiate) {
...
EXT_RETURN
tls_construct_ctos_server_name(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                               size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_maxfragmentlen(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                                  size_t chainidx)
{
    ...
    if (!WPACKET_put_bytes_u16(pkt, TLSEXT_TYPE_max_fragment_length)
        ...
        || !WPACKET_start_sub_packet_u16(pkt) ||
        !WPACKET_put_bytes_u8(pkt, s->ext.max_fragment_len_mode) || !WPACKET_close(pkt)) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
        return EXT_RETURN_FAIL;
    }
...
EXT_RETURN
tls_construct_ctos_srp(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                       size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_ec_pt_formats(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                                 size_t chainidx)
{
    ...
    if (!WPACKET_put_bytes_u16(pkt, TLSEXT_TYPE_ec_point_formats)
        ...
        || !WPACKET_start_sub_packet_u16(pkt) ||
        !WPACKET_sub_memcpy_u8(pkt, pformats, num_formats) || !WPACKET_close(pkt)) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
        return EXT_RETURN_FAIL;
    }
...
EXT_RETURN
tls_construct_ctos_supported_groups(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                                    size_t chainidx)
{
    const uint16_t *pgroups = NULL;
...
EXT_RETURN
tls_construct_ctos_session_ticket(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                                  size_t chainidx)
{
    size_t ticklen;
...
EXT_RETURN
tls_construct_ctos_sig_algs(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                            size_t chainidx)
{
    size_t salglen;
    const uint16_t *salg;
    ...
    if (!WPACKET_put_bytes_u16(pkt, TLSEXT_TYPE_signature_algorithms)
        ...
        || !WPACKET_start_sub_packet_u16(pkt) || !tls12_copy_sigalgs(s, pkt, salg, salglen) ||
        !WPACKET_close(pkt) || !WPACKET_close(pkt)) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
        return EXT_RETURN_FAIL;
    }
...
EXT_RETURN
tls_construct_ctos_status_request(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                                  size_t chainidx)
{
    int i;
...
EXT_RETURN
tls_construct_ctos_npn(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                       size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_alpn(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                        size_t chainidx)
{
    s->s3.alpn_sent = 0;
    ...
    if (!WPACKET_put_bytes_u16(pkt, TLSEXT_TYPE_application_layer_protocol_negotiation)
        ...
        || !WPACKET_start_sub_packet_u16(pkt) ||
        !WPACKET_sub_memcpy_u16(pkt, s->ext.alpn, s->ext.alpn_len) || !WPACKET_close(pkt)) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
        return EXT_RETURN_FAIL;
    }
    s->s3.alpn_sent = 1;
...
EXT_RETURN
tls_construct_ctos_use_srtp(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                            size_t chainidx)
{
    SSL *ssl = SSL_CONNECTION_GET_SSL(s);
...
EXT_RETURN
tls_construct_ctos_etm(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                       size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_sct(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                       size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_ems(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                       size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_supported_versions(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
 ...
 */
EXT_RETURN
tls_construct_ctos_psk_kex_modes(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                                 size_t chainidx)
{
    ...
    if (!WPACKET_put_bytes_u16(pkt, TLSEXT_TYPE_psk_kex_modes) ||
        ...
        (nodhe && !WPACKET_put_bytes_u8(pkt, TLSEXT_KEX_MODE_KE)) || !WPACKET_close(pkt) ||
        !WPACKET_close(pkt)) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
        return EXT_RETURN_FAIL;
    }
...
#ifndef OPENSSL_NO_TLS1_3
static int
add_key_share(SSL_CONNECTION *s, WPACKET *pkt, unsigned int group_id, size_t loop_num)
{
...
EXT_RETURN
tls_construct_ctos_key_share(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                             size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
EXT_RETURN
tls_construct_ctos_cookie(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                          size_t chainidx)
{
...
EXT_RETURN
tls_construct_ctos_early_data(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                              size_t chainidx)
{
    ...
    if (psksess == NULL && s->psk_client_callback != NULL) {
        ...
        psklen =
            s->psk_client_callback(ussl, NULL, identity, sizeof(identity) - 1, psk, sizeof(psk));
...
EXT_RETURN
tls_construct_ctos_padding(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                           size_t chainidx)
{
 ...
 */
EXT_RETURN
tls_construct_ctos_psk(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context, X509 *x,
                       size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
dopsksess:
    ...
    if (dores && tls_psk_do_binder(s, mdres, msgstart, binderoffset, NULL, resbinder, s->session, 1,
                                   0) != 1) {
        /* SSLfatal() already called */
        return EXT_RETURN_FAIL;
    }

    if (s->psksession != NULL && tls_psk_do_binder(s, mdpsk, msgstart, binderoffset, NULL,
...
tls_construct_ctos_post_handshake_auth(SSL_CONNECTION *s, WPACKET *pkt,
                                       ossl_unused unsigned int context, ossl_unused X509 *x,
 ...
 */
int
tls_parse_stoc_renegotiate(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                           size_t chainidx)
{
...
int
tls_parse_stoc_maxfragmentlen(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                              size_t chainidx)
{
    unsigned int value;
...
int
tls_parse_stoc_server_name(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                           size_t chainidx)
{
    if (s->ext.hostname == NULL) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
...
int
tls_parse_stoc_ec_pt_formats(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                             size_t chainidx)
{
...
int
tls_parse_stoc_session_ticket(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                              size_t chainidx)
{
...
#ifndef OPENSSL_NO_OCSP
int
tls_parse_stoc_status_request(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                              size_t chainidx)
{
...
#ifndef OPENSSL_NO_CT
int
tls_parse_stoc_sct(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x, size_t chainidx)
{
    if (context == SSL_EXT_TLS1_3_CERTIFICATE_REQUEST) {
    ...
    if (s->ct_validation_callback != NULL) {
        ...
        ENDPOINT role =
            (context & SSL_EXT_TLS1_2_SERVER_HELLO) != 0 ? ENDPOINT_CLIENT : ENDPOINT_BOTH;

        /*
         * If we didn't ask for it then there must be a custom extension,
         * otherwise this is unsolicited.
         */
        if (custom_ext_find(&s->cert->custext, role, TLSEXT_TYPE_signed_certificate_timestamp,
                            NULL) == NULL) {
...
int
tls_parse_stoc_npn(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x, size_t chainidx)
{
    ...
    if (sctx->ext.npn_select_cb(SSL_CONNECTION_GET_USER_SSL(s), &selected, &selected_len,
...
int
tls_parse_stoc_alpn(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x, size_t chainidx)
{
    size_t len;
...
#ifndef OPENSSL_NO_SRTP
int
tls_parse_stoc_use_srtp(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                        size_t chainidx)
{
...
int
tls_parse_stoc_etm(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x, size_t chainidx)
{
...
int
tls_parse_stoc_ems(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x, size_t chainidx)
{
    if (s->options & SSL_OP_NO_EXTENDED_MASTER_SECRET)
        return 1;
...
int
tls_parse_stoc_supported_versions(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                                  size_t chainidx)
{
...
int
tls_parse_stoc_key_share(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                         size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
int
tls_parse_stoc_cookie(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                      size_t chainidx)
{
    PACKET cookie;
...
int
tls_parse_stoc_early_data(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x,
                          size_t chainidx)
{
...
int
tls_parse_stoc_psk(SSL_CONNECTION *s, PACKET *pkt, unsigned int context, X509 *x, size_t chainidx)
{
#ifndef OPENSSL_NO_TLS1_3
...
EXT_RETURN
tls_construct_ctos_client_cert_type(SSL_CONNECTION *sc, WPACKET *pkt, unsigned int context, X509 *x,
                                    size_t chainidx)
{
...
int
tls_parse_stoc_client_cert_type(SSL_CONNECTION *sc, PACKET *pkt, unsigned int context, X509 *x,
                                size_t chainidx)
{
    unsigned int type;
...
EXT_RETURN
tls_construct_ctos_server_cert_type(SSL_CONNECTION *sc, WPACKET *pkt, unsigned int context, X509 *x,
                                    size_t chainidx)
{
...
int
tls_parse_stoc_server_cert_type(SSL_CONNECTION *sc, PACKET *pkt, unsigned int context, X509 *x,
                                size_t chainidx)
{
    unsigned int type;
