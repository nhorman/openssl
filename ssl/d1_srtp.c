...
static int
find_profile_by_name(char *profile_name, const SRTP_PROTECTION_PROFILE **pptr, size_t len)
{
...
static int
ssl_ctx_make_profiles(const char *profiles_string, STACK_OF(SRTP_PROTECTION_PROFILE) * *out)
{
