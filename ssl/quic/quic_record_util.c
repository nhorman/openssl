 ...
 */
int
ossl_quic_hkdf_extract(OSSL_LIB_CTX *libctx, const char *propq, const EVP_MD *md,
...
static const unsigned char quic_v1_initial_salt[] = {0x38, 0x76, 0x2c, 0xf7, 0xf5, 0x59, 0x34,
                                 ...
                                 struct ossl_qrx_st *qrx, struct ossl_qtx_st *qtx)
{
    ...
    if (!ossl_quic_hkdf_extract(libctx, propq, sha256, quic_v1_initial_salt,
                                sizeof(quic_v1_initial_salt), dst_conn_id->id, dst_conn_id->id_len,
    ...
    if (qrx != NULL && !ossl_qrx_provide_secret(qrx, QUIC_ENC_LEVEL_INITIAL, QRL_SUITE_AES128GCM,
    ...
    /* Setup TX cipher. */
    if (qtx != NULL && !ossl_qtx_provide_secret(qtx, QUIC_ENC_LEVEL_INITIAL, QRL_SUITE_AES128GCM,
