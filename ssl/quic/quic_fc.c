...
ossl_quic_rxfc_init(QUIC_RXFC *rxfc, QUIC_RXFC *conn_rxfc, uint64_t initial_window_size,
                    uint64_t max_window_size, OSSL_TIME (*now)(void *now_arg), void *now_arg)
{
...
rxfc_cwm_bump_desired(QUIC_RXFC *rxfc)
{
    ...
    uint64_t threshold = safe_muldiv_uint64_t(rxfc->cur_window_size, WINDOW_THRESHOLD_NUM,
...
static void
rxfc_adjust_window_size(QUIC_RXFC *rxfc, uint64_t min_window_size, OSSL_TIME rtt)
{
...
static int
rxfc_on_retire(QUIC_RXFC *rxfc, uint64_t num_bytes, uint64_t min_window_size, OSSL_TIME rtt)
{
