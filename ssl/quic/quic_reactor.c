...
ossl_quic_reactor_init(QUIC_REACTOR *rtor,
                       ...
                       void *tick_cb_arg, CRYPTO_MUTEX *mutex, OSSL_TIME initial_tick_deadline,
                       uint64_t flags)
{
...
OSSL_TIME
ossl_quic_reactor_get_tick_deadline(QUIC_REACTOR *rtor) { return rtor->tick_deadline; }
 ...
 */
static int
poll_two_fds(int rfd, int rfd_want_read, int wfd, int wfd_want_write, int notify_rfd,
             OSSL_TIME deadline, CRYPTO_MUTEX *mutex)
{
 ...
 */
static int
poll_two_descriptors(const BIO_POLL_DESCRIPTOR *r, int r_want_read, const BIO_POLL_DESCRIPTOR *w,
 ...
 */
int
ossl_quic_reactor_block_until_pred(QUIC_REACTOR *rtor, int (*pred)(void *arg), void *pred_arg,
                                   uint32_t flags)
{
