...
add_provider_sigalgs(const OSSL_PARAM params[], void *data)
{
    ...
    ERR_set_mark();
    keytype =
        (sinf->keytype != NULL ? sinf->keytype
 ...
 */
void
tls1_get_supported_groups(SSL_CONNECTION *s, const uint16_t **pgroups, size_t *pgroupslen)
{
 ...
 */
void
tls1_get_requested_keyshare_groups(SSL_CONNECTION *s, const uint16_t **pgroups, size_t *pgroupslen)
{
    SSL_CTX *sctx = SSL_CONNECTION_GET_CTX(s);
...
void
tls1_get_group_tuples(SSL_CONNECTION *s, const size_t **ptuples, size_t *ptupleslen)
{
    SSL_CTX *sctx = SSL_CONNECTION_GET_CTX(s);
...
int
tls_valid_group(SSL_CONNECTION *s, uint16_t group_id, int minversion, int maxversion, int isec,
                int *okfortls13)
{
    ...
    ret &= !isec || strcmp(ginfo->algorithm, "EC") == 0 ||
           strcmp(ginfo->algorithm, "X25519") == 0 || strcmp(ginfo->algorithm, "X448") == 0;
...
int
tls1_get0_implemented_groups(int min_proto_version, int max_proto_version, TLS_GROUP_INFO *grps,
                             size_t num, long all, STACK_OF(OPENSSL_CSTRING) * out)
{
...
int
tls1_set_groups(uint16_t **grpext, size_t *grpextlen, uint16_t **ksext, size_t *ksextlen,
                size_t **tplext, size_t *tplextlen, int *groups, size_t ngroups)
{
...
static const default_group_string_st default_group_strings[] = {
    {DEFAULT_GROUP_NAME, TLS_DEFAULT_GROUP_LIST}, {SUITE_B_GROUP_NAME, SUITE_B_GROUP_LIST}};
...
gid_cb(const char *elem, int len, void *arg)
{
    ...
    while (continue_while_loop && len > 0 &&
           ((current_prefix = strchr(prefixes, elem[0])) != NULL ||
            OPENSSL_strncasecmp(current_prefix = (char *)DEFAULT_GROUPNAME_FIRST_CHARACTER, elem,
                                1) == 0)) {
            ...
            for (i = 0; i < OSSL_NELEM(default_group_strings); i++) {
                if ((size_t)len == (strlen(default_group_strings[i].list_name)) &&
                    ...
                    restored_default_group_string = OPENSSL_malloc(
                        (1 /* max prefix length */ + strlen(default_group_strings[i].group_string) +
                         1 /* \0 */) *
                        sizeof(char));
    ...
    if (garg->ksidcnt == garg->ksidmax) {
        uint16_t *tmp = OPENSSL_realloc(garg->ksid_arr, (garg->ksidmax + GROUPLIST_INCREMENT) *
...
tuple_cb(const char *tuple, int len, void *arg)
{
    ...
    if (garg->tplcnt == garg->tplmax) {
        size_t *tmp = OPENSSL_realloc(garg->tuplcnt_arr, (garg->tplmax + GROUPLIST_INCREMENT) *
 ...
 */
int
tls1_set_groups_list(SSL_CTX *ctx, uint16_t **grpext, size_t *grpextlen, uint16_t **ksext,
                     size_t *ksextlen, size_t **tplext, size_t *tplextlen, const char *str)
{
    size_t i = 0, j;
...
static const SIGALG_LOOKUP sigalg_lookup_tbl[] = {
    {TLSEXT_SIGALG_ecdsa_secp256r1_sha256_name, "ECDSA+SHA256",
     TLSEXT_SIGALG_ecdsa_secp256r1_sha256, NID_sha256, SSL_MD_SHA256_IDX, EVP_PKEY_EC, SSL_PKEY_ECC,
     NID_ecdsa_with_SHA256, NID_X9_62_prime256v1, 1, 0, TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_ecdsa_secp384r1_sha384_name, "ECDSA+SHA384",
     TLSEXT_SIGALG_ecdsa_secp384r1_sha384, NID_sha384, SSL_MD_SHA384_IDX, EVP_PKEY_EC, SSL_PKEY_ECC,
     NID_ecdsa_with_SHA384, NID_secp384r1, 1, 0, TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_ecdsa_secp521r1_sha512_name, "ECDSA+SHA512",
     TLSEXT_SIGALG_ecdsa_secp521r1_sha512, NID_sha512, SSL_MD_SHA512_IDX, EVP_PKEY_EC, SSL_PKEY_ECC,
     NID_ecdsa_with_SHA512, NID_secp521r1, 1, 0, TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},

    {TLSEXT_SIGALG_ed25519_name, NULL, TLSEXT_SIGALG_ed25519, NID_undef, -1, EVP_PKEY_ED25519,
     SSL_PKEY_ED25519, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_ed448_name, NULL, TLSEXT_SIGALG_ed448, NID_undef, -1, EVP_PKEY_ED448,
     SSL_PKEY_ED448, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},

    {TLSEXT_SIGALG_ecdsa_sha224_name, "ECDSA+SHA224", TLSEXT_SIGALG_ecdsa_sha224, NID_sha224,
     SSL_MD_SHA224_IDX, EVP_PKEY_EC, SSL_PKEY_ECC, NID_ecdsa_with_SHA224, NID_undef, 1, 0,
     TLS1_2_VERSION, TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_ecdsa_sha1_name, "ECDSA+SHA1", TLSEXT_SIGALG_ecdsa_sha1, NID_sha1,
     SSL_MD_SHA1_IDX, EVP_PKEY_EC, SSL_PKEY_ECC, NID_ecdsa_with_SHA1, NID_undef, 1, 0,
     TLS1_2_VERSION, TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    ...
    {TLSEXT_SIGALG_ecdsa_brainpoolP256r1_sha256_name,
     ...
     NID_sha256, SSL_MD_SHA256_IDX, EVP_PKEY_EC, SSL_PKEY_ECC, NID_ecdsa_with_SHA256,
    ...
    {TLSEXT_SIGALG_ecdsa_brainpoolP384r1_sha384_name,
     ...
     NID_sha384, SSL_MD_SHA384_IDX, EVP_PKEY_EC, SSL_PKEY_ECC, NID_ecdsa_with_SHA384,
    ...
    {TLSEXT_SIGALG_ecdsa_brainpoolP512r1_sha512_name,
     ...
     NID_sha512, SSL_MD_SHA512_IDX, EVP_PKEY_EC, SSL_PKEY_ECC, NID_ecdsa_with_SHA512,
     NID_brainpoolP512r1, 1, 0, TLS1_3_VERSION, 0, -1, -1},

    {TLSEXT_SIGALG_rsa_pss_rsae_sha256_name, "PSS+SHA256", TLSEXT_SIGALG_rsa_pss_rsae_sha256,
     NID_sha256, SSL_MD_SHA256_IDX, EVP_PKEY_RSA_PSS, SSL_PKEY_RSA, NID_undef, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_rsa_pss_rsae_sha384_name, "PSS+SHA384", TLSEXT_SIGALG_rsa_pss_rsae_sha384,
     NID_sha384, SSL_MD_SHA384_IDX, EVP_PKEY_RSA_PSS, SSL_PKEY_RSA, NID_undef, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_rsa_pss_rsae_sha512_name, "PSS+SHA512", TLSEXT_SIGALG_rsa_pss_rsae_sha512,
     NID_sha512, SSL_MD_SHA512_IDX, EVP_PKEY_RSA_PSS, SSL_PKEY_RSA, NID_undef, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},

    {TLSEXT_SIGALG_rsa_pss_pss_sha256_name, NULL, TLSEXT_SIGALG_rsa_pss_pss_sha256, NID_sha256,
     SSL_MD_SHA256_IDX, EVP_PKEY_RSA_PSS, SSL_PKEY_RSA_PSS_SIGN, NID_undef, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_rsa_pss_pss_sha384_name, NULL, TLSEXT_SIGALG_rsa_pss_pss_sha384, NID_sha384,
     SSL_MD_SHA384_IDX, EVP_PKEY_RSA_PSS, SSL_PKEY_RSA_PSS_SIGN, NID_undef, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_rsa_pss_pss_sha512_name, NULL, TLSEXT_SIGALG_rsa_pss_pss_sha512, NID_sha512,
     SSL_MD_SHA512_IDX, EVP_PKEY_RSA_PSS, SSL_PKEY_RSA_PSS_SIGN, NID_undef, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},

    {TLSEXT_SIGALG_rsa_pkcs1_sha256_name, "RSA+SHA256", TLSEXT_SIGALG_rsa_pkcs1_sha256, NID_sha256,
     SSL_MD_SHA256_IDX, EVP_PKEY_RSA, SSL_PKEY_RSA, NID_sha256WithRSAEncryption, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_rsa_pkcs1_sha384_name, "RSA+SHA384", TLSEXT_SIGALG_rsa_pkcs1_sha384, NID_sha384,
     SSL_MD_SHA384_IDX, EVP_PKEY_RSA, SSL_PKEY_RSA, NID_sha384WithRSAEncryption, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},
    {TLSEXT_SIGALG_rsa_pkcs1_sha512_name, "RSA+SHA512", TLSEXT_SIGALG_rsa_pkcs1_sha512, NID_sha512,
     SSL_MD_SHA512_IDX, EVP_PKEY_RSA, SSL_PKEY_RSA, NID_sha512WithRSAEncryption, NID_undef, 1, 0,
     TLS1_2_VERSION, 0, DTLS1_2_VERSION, 0},

    {TLSEXT_SIGALG_rsa_pkcs1_sha224_name, "RSA+SHA224", TLSEXT_SIGALG_rsa_pkcs1_sha224, NID_sha224,
     SSL_MD_SHA224_IDX, EVP_PKEY_RSA, SSL_PKEY_RSA, NID_sha224WithRSAEncryption, NID_undef, 1, 0,
     TLS1_2_VERSION, TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_rsa_pkcs1_sha1_name, "RSA+SHA1", TLSEXT_SIGALG_rsa_pkcs1_sha1, NID_sha1,
     SSL_MD_SHA1_IDX, EVP_PKEY_RSA, SSL_PKEY_RSA, NID_sha1WithRSAEncryption, NID_undef, 1, 0,
     TLS1_2_VERSION, TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},

    {TLSEXT_SIGALG_dsa_sha256_name, "DSA+SHA256", TLSEXT_SIGALG_dsa_sha256, NID_sha256,
     SSL_MD_SHA256_IDX, EVP_PKEY_DSA, SSL_PKEY_DSA_SIGN, NID_dsa_with_SHA256, NID_undef, 1, 0,
     TLS1_2_VERSION, TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_dsa_sha384_name, "DSA+SHA384", TLSEXT_SIGALG_dsa_sha384, NID_sha384,
     SSL_MD_SHA384_IDX, EVP_PKEY_DSA, SSL_PKEY_DSA_SIGN, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION,
     TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_dsa_sha512_name, "DSA+SHA512", TLSEXT_SIGALG_dsa_sha512, NID_sha512,
     SSL_MD_SHA512_IDX, EVP_PKEY_DSA, SSL_PKEY_DSA_SIGN, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION,
     TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_dsa_sha224_name, "DSA+SHA224", TLSEXT_SIGALG_dsa_sha224, NID_sha224,
     SSL_MD_SHA224_IDX, EVP_PKEY_DSA, SSL_PKEY_DSA_SIGN, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION,
     TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_dsa_sha1_name, "DSA+SHA1", TLSEXT_SIGALG_dsa_sha1, NID_sha1, SSL_MD_SHA1_IDX,
     EVP_PKEY_DSA, SSL_PKEY_DSA_SIGN, NID_dsaWithSHA1, NID_undef, 1, 0, TLS1_2_VERSION,
     TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    ...
    {TLSEXT_SIGALG_gostr34102012_256_intrinsic_alias, /* RFC9189 */
     ...
     NID_id_GostR3411_2012_256, SSL_MD_GOST12_256_IDX, NID_id_GostR3410_2012_256,
     SSL_PKEY_GOST12_256, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION, TLS1_2_VERSION,
     DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_gostr34102012_256_intrinsic_alias, /* RFC9189 */
     TLSEXT_SIGALG_gostr34102012_256_intrinsic_name, TLSEXT_SIGALG_gostr34102012_512_intrinsic,
     NID_id_GostR3411_2012_512, SSL_MD_GOST12_512_IDX, NID_id_GostR3410_2012_512,
     SSL_PKEY_GOST12_512, NID_undef, NID_undef, 1, 0, TLS1_2_VERSION, TLS1_2_VERSION,
     DTLS1_2_VERSION, DTLS1_2_VERSION},
    ...
    {TLSEXT_SIGALG_gostr34102012_256_gostr34112012_256_name, NULL,
     ...
     SSL_MD_GOST12_256_IDX, NID_id_GostR3410_2012_256, SSL_PKEY_GOST12_256, NID_undef, NID_undef, 1,
    ...
    {TLSEXT_SIGALG_gostr34102012_512_gostr34112012_512_name, NULL,
     ...
     SSL_MD_GOST12_512_IDX, NID_id_GostR3410_2012_512, SSL_PKEY_GOST12_512, NID_undef, NID_undef, 1,
     0, TLS1_2_VERSION, TLS1_2_VERSION, DTLS1_2_VERSION, DTLS1_2_VERSION},
    {TLSEXT_SIGALG_gostr34102001_gostr3411_name, NULL, TLSEXT_SIGALG_gostr34102001_gostr3411,
     NID_id_GostR3411_94, SSL_MD_GOST94_IDX, NID_id_GostR3410_2001, SSL_PKEY_GOST01, NID_undef,
...
static int
rsa_pss_check_min_key_size(SSL_CTX *ctx, const EVP_PKEY *pkey, const SIGALG_LOOKUP *lu)
{
    const EVP_MD *md;
...
tls1_get_legacy_sigalg(const SSL_CONNECTION *s, int idx)
{
    if (idx == -1) {
        if (s->server) {
             ...
             * with new (aGOST12-only) ciphersuites, we should find out which one is available
             * really.
             */
...
tls12_check_peer_sigalg(SSL_CONNECTION *s, uint16_t sig, EVP_PKEY *pkey)
{
    ...
    if (i == sent_sigslen &&
        (lu->hash != NID_sha1 || s->cert->cert_flags & SSL_CERT_FLAGS_CHECK_TLS_STRICT)) {
        SSLfatal(s, SSL_AD_HANDSHAKE_FAILURE, SSL_R_WRONG_SIGNATURE_TYPE);
        return 0;
    }
    ...
    if (secbits == 0 ||
        !ssl_security(s, SSL_SECOP_SIGALG_CHECK, secbits,
                      md != NULL ? EVP_MD_get_type(md) : NID_undef, (void *)sigalgstr)) {
        SSLfatal(s, SSL_AD_HANDSHAKE_FAILURE, SSL_R_WRONG_SIGNATURE_TYPE);
        return 0;
    }
 ...
 */
int
ssl_cipher_disabled(const SSL_CONNECTION *s, const SSL_CIPHER *c, int op, int ecdhe)
{
 ...
 */
SSL_TICKET_STATUS
tls_get_ticket_from_client(SSL_CONNECTION *s, CLIENTHELLO_MSG *hello, SSL_SESSION **ret)
{
    size_t size;
    ...
    *ret = NULL;
    ...
    return tls_decrypt_ticket(s, PACKET_data(&ticketext->data), size, hello->session_id,
 ...
 */
SSL_TICKET_STATUS
tls_decrypt_ticket(SSL_CONNECTION *s, const unsigned char *etick, size_t eticklen,
                   const unsigned char *sess_id, size_t sesslen, SSL_SESSION **psess)
{
    ...
    if (s->session_ctx->decrypt_ticket_cb != NULL &&
        ...
        retcb = s->session_ctx->decrypt_ticket_cb(SSL_CONNECTION_GET_SSL(s), sess, etick,
                                                  keyname_len, ret, s->session_ctx->ticket_cb_data);
        switch (retcb) {
...
int
tls12_copy_sigalgs(SSL_CONNECTION *s, WPACKET *pkt, const uint16_t *psig, size_t psiglen)
{
    size_t i;
    int rv = 0;
...
static size_t
tls12_shared_sigalgs(SSL_CONNECTION *s, const SIGALG_LOOKUP **shsig, const uint16_t *pref,
                     size_t preflen, const uint16_t *allow, size_t allowlen)
{
...
int
SSL_get_sigalgs(SSL *s, int idx, int *psign, int *phash, int *psignhash, unsigned char *rsig,
                unsigned char *rhash)
{
    uint16_t *psig;
    size_t numsigalgs;
...
int
SSL_get_shared_sigalgs(SSL *s, int idx, int *psign, int *phash, int *psignhash, unsigned char *rsig,
                       unsigned char *rhash)
{
    ...
    if (sc->shared_sigalgs == NULL || idx < 0 || idx >= (int)sc->shared_sigalgslen ||
...
tls1_check_sig_alg(SSL_CONNECTION *s, X509 *x, int default_nid)
{
    ...
    for (i = 0; i < sigalgslen; i++) {
        ...
        sigalg = use_pc_sigalgs
                     ? tls1_lookup_sigalg(SSL_CONNECTION_GET_CTX(s), s->s3.tmp.peer_cert_sigalgs[i])
                     : s->shared_sigalgs[i];
        if (sigalg == NULL)
            continue;
...
#define CERT_PKEY_STRICT_FLAGS                                                                     \
    (CERT_PKEY_VALID_FLAGS | CERT_PKEY_CA_SIGNATURE | CERT_PKEY_CA_PARAM | CERT_PKEY_ISSUER_NAME | \
     CERT_PKEY_CERT_TYPE)

int
tls1_check_chain(SSL_CONNECTION *s, X509 *x, EVP_PKEY *pk, STACK_OF(X509) * chain, int idx)
{
    int i;
    int rv = 0;
 ...
 */
static int
check_cert_usable(SSL_CONNECTION *s, const SIGALG_LOOKUP *sig, X509 *x, EVP_PKEY *pkey)
{
    const SIGALG_LOOKUP *lu;
 ...
 */
static int
is_cert_usable(SSL_CONNECTION *s, const SIGALG_LOOKUP *sig, X509 *x, EVP_PKEY *pkey)
{
    size_t idx;
...
find_sig_alg(SSL_CONNECTION *s, X509 *x, EVP_PKEY *pkey)
{
    ...
    for (i = 0; i < s->shared_sigalgslen; i++) {
        ...
        if (lu->hash == NID_sha1 || lu->hash == NID_sha224 || lu->sig == EVP_PKEY_DSA ||
            lu->sig == EVP_PKEY_RSA || !tls_sigalg_compat(s, lu))
            continue;
...
__owur int
tls13_set_encoded_pub_key(EVP_PKEY *pkey, const unsigned char *enckey, size_t enckeylen)
{
