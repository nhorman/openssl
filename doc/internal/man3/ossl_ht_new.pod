...
of:
    ...
    I<ht_select_fn> The function to select from a set of colliding values, may be NULL.
    I<max_chain_length> The max length of colliding hash chains - ignored if ht_select_fn is NULL
...
Note The calling convention of I<ht_select_fn> is to return 0 if the passed value
should not be selected for the operation requested, and to return 1 if it should. 
