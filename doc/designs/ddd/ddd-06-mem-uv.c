...
static int write_deferred(APP_CONN *conn, const void *buf, size_t buf_len, app_write_cb *cb,
                          void *arg);
...
APP_CONN *
new_conn(SSL_CTX *ctx, const char *hostname, struct sockaddr *sa, socklen_t sa_len,
 ...
 */
int
app_write(APP_CONN *conn, const void *buf, size_t buf_len, app_write_cb *cb, void *arg)
{
...
#ifdef USE_QUIC
static void
net_read_done(uv_udp_t *stream, ssize_t nr, const uv_buf_t *buf, const struct sockaddr *addr,
              unsigned int flags)
#else
static void
...
static int
write_deferred(APP_CONN *conn, const void *buf, size_t buf_len, app_write_cb *cb, void *arg)
{
