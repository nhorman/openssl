...
static int
load_record(TLS_RL_RECORD *rec, RECORD_DATA *recd, unsigned char **key, unsigned char *iv,
...
test_tls13_encryption(void)
{
    ...
    for (ctr = 0; ctr < OSSL_NELEM(refdata); ctr++) {
        ...
        if (!TEST_true(ossl_tls_record_method.new_record_layer(
                ...
                OSSL_RECORD_PROTECTION_LEVEL_APPLICATION, 0, NULL, 0, key, 16, iv, ivlen, NULL, 0,
                EVP_aes_128_gcm(), EVP_GCM_TLS_TAG_LEN, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
