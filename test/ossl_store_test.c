...
test_store_open(void)
{
    ...
    ret =
        TEST_ptr(input) && TEST_ptr(search = OSSL_STORE_SEARCH_by_alias("nothing")) &&
...
static const unsigned char mscert[] = {
    0x30, 0x82, 0x01, 0x3b, 0x30, 0x81, 0xee, 0xa0, 0x03, 0x02, 0x01, 0x02, 0x02, 0x01, 0x00, 0x30,
    0x05, 0x06, 0x03, 0x2b, 0x65, 0x70, 0x30, 0x81, 0x88, 0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55,
    ...
    ,
...
test_store_open_winstore(void)
{
    ...
    ret = TEST_ptr(testcert = d2i_X509(NULL, &certptr, TEST_CERT_LEN)) &&
          ...
          TEST_ptr(ui_method = UI_create_method("DummyUI")) &&
          TEST_ptr(sctx = OSSL_STORE_open_ex("org.openssl.winstore:", NULL, NULL, ui_method, NULL,
                                             NULL, NULL, NULL)) &&
...
test_store_attach_unregistered_scheme(void)
{
    ...
    ret = TEST_ptr(input) && TEST_ptr(libctx = OSSL_LIB_CTX_new()) &&
          ...
          TEST_ptr(store_ctx = OSSL_STORE_attach(bio, "file", libctx, NULL, NULL, NULL, NULL, NULL,
                                                 NULL)) &&
...
test_get_options(void)
{
    static const OPTIONS test_options[] = {
        OPT_TEST_OPTIONS_DEFAULT_USAGE, {"dir", OPT_INPUTDIR, '/'}, {"in", OPT_INFILE, '<'},
        {"sm2", OPT_SM2FILE, '<'},      {"data", OPT_DATADIR, 's'}, {NULL}};
    return test_options;
}
