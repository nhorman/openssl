...
static int test_dh_paramfromdata(void)
{
    ...
    ret = TEST_ptr(ctx = EVP_PKEY_CTX_new_from_name(mainctx, "DH", NULL))
          ...
          && TEST_int_eq(set_fromdata_string(ctx,
...
static int test_d2i_AutoPrivateKey_ex(int i)
{
    ...
    if (ak->evptype == EVP_PKEY_DH) {
        if (!TEST_true(EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_FFC_P,
                                             &p_bn))
...
static int test_d2i_PrivateKey_ex(int testid)
{
    ...
    if (!TEST_ptr(key_bio =
        ...
        goto err;
    if (!TEST_ptr_null(pkey = PEM_read_bio_PrivateKey(key_bio, NULL, NULL,
                                                      NULL)))
        goto err;
...
static int test_PEM_read_bio_negative(int testid)
{
    ...
    if (!TEST_ptr(key_bio =
                      BIO_new_mem_buf(keydata[testid].kder,
                                      keydata[testid].size)))
        goto err;
    ERR_clear_error();
    if (!TEST_ptr_null(pkey = PEM_read_bio_PrivateKey(key_bio, NULL, NULL,
...
static const unsigned char dsa_p[] = {
    ...
    ,
...
static const unsigned char dsa_q[] = {
    0x00, 0xe0, 0x20, 0xe0, 0x7c, 0x02, 0x16, 0xa7, 0x6c, 0x6a, 0x19, 0xba,
    0xd5, 0x83, 0x73,
    0xf3, 0x7d, 0x31, 0xef, 0xa7, 0xe1, 0x5d, 0x5b, 0x7f, 0xf3, 0xfc, 0xda,
    0x84, 0x31
};
static const unsigned char dsa_g[] = {
    ,
...
static const unsigned char dsa_priv[] = {
    0x2f, 0x68, 0x44, 0xcb, 0xfb, 0x6b, 0xcb, 0x8d, 0x02, 0x49, 0x7c, 0xee,
    0xd2, 0xa6, 0xd3,
...
static const unsigned char dsa_pub[] = {
    
...
static int test_dsa_todata(void)
{
    ...
    if (!TEST_ptr(pkey = d2i_AutoPrivateKey_ex(NULL, &pkeydata, sizeof(dsa_key),
        ...
        || !TEST_ptr_null(OSSL_PARAM_locate(to_params,
