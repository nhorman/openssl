...
test_rand(void)
{
    ...
    *p++ =
        OSSL_PARAM_construct_octet_string(OSSL_RAND_PARAM_TEST_ENTROPY, entropy1, sizeof(entropy1));
    ...
    *params =
        OSSL_PARAM_construct_octet_string(OSSL_RAND_PARAM_TEST_ENTROPY, entropy2, sizeof(entropy2));
...
static int
r_random_bytes(ossl_unused void *vprov, ossl_unused int which, void *buf, size_t n,
