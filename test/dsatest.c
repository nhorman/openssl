...
dsa_test(void)
{
    ...
    if (!TEST_ptr(dsa = DSA_new()) ||
        !TEST_true(DSA_generate_parameters_ex(dsa, 512, seed, 20, &counter, &h, cb)))
        goto end;
...
dsa_keygen_test(void)
{
    ...
    static const unsigned char seed_data[] = {
        0xa6, 0xf5, 0x28, 0x8c, 0x50, 0x77, 0xa5, 0x68, 0x6d, 0x3a, 0xf5, 0xf1, 0xc6, 0x4c,
        0xdc, 0x35, 0x95, 0x26, 0x3f, 0x03, 0xdc, 0x00, 0x3f, 0x44, 0x7b, 0x2a, 0xc7, 0x29};
    static const unsigned char expected_p[] = {
        };
    static const unsigned char expected_q[] = {
        0x99, 0xb6, 0xa0, 0xee, 0xb3, 0xa6, 0x99, 0x1a, 0xb6, 0x67, 0x8d, 0xc1, 0x2b, 0x9b,
        0xce, 0x2b, 0x01, 0x72, 0x5a, 0x65, 0x76, 0x3d, 0x93, 0x69, 0xe2, 0x56, 0xae, 0xd7};
    static const unsigned char expected_g[] = {
        };
    int expected_c = 1316;
    int expected_h = 2;
    ...
    if (!TEST_true(EVP_PKEY_get_bn_param(key, OSSL_PKEY_PARAM_FFC_P, &p_out)) ||
        ...
        !TEST_true(EVP_PKEY_get_octet_string_param(key, OSSL_PKEY_PARAM_FFC_SEED, seed_out,
                                                   sizeof(seed_out), &len)) ||
        ...
        !TEST_false(EVP_PKEY_get_utf8_string_param(key, OSSL_PKEY_PARAM_GROUP_NAME, group_out,
...
test_dsa_sig_infinite_loop(void)
{
    ...
    if (!TEST_true(DSA_sign(0, msg, sizeof(msg), signature, &signature_len, dsa)) ||
        !TEST_int_gt(signature_len, 0) || !TEST_int_le(signature_len, signature_len0))
        goto err;
