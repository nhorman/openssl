...
test_idea_cfb64(void)
{
    ...
    IDEA_cfb64_encrypt(&plain[12], &cfb_buf1[12], (long)CFB_TEST_SIZE - 12, &eks, cfb_tmp, &n,
                       IDEA_ENCRYPT);
    ...
    IDEA_cfb64_encrypt(&cfb_buf1[13], &cfb_buf2[13], (long)CFB_TEST_SIZE - 13, &eks, cfb_tmp, &n,
                       IDEA_DECRYPT);
