...
static int
fake_rsa_keymgmt_export(void *keydata, int selection, OSSL_CALLBACK *param_callback, void *cbarg)
{
...
static int
fake_rsa_sig_sign(void *ctx, unsigned char *sig, size_t *siglen, size_t sigsize,
...
static int
fake_rsa_dgstsgnvfy_init(void *ctx, unsigned char type, void *provkey, const OSSL_PARAM params[])
{
    unsigned char *sigctx = ctx;
    struct fake_rsa_keydata *keydata = provkey;
...
static int
fake_rsa_dgstsgn_init(void *ctx, const char *mdname, void *provkey, const OSSL_PARAM params[])
{
    return fake_rsa_dgstsgnvfy_init(ctx, FAKE_DGSTSGN_SIGN, provkey, params);
}

static int
fake_rsa_dgstvfy_init(void *ctx, const char *mdname, void *provkey, const OSSL_PARAM params[])
{
...
static int
fake_rsa_dgstsgnvfy_final(void *ctx, unsigned char *sig, size_t *siglen, size_t sigsize)
{
    unsigned char *sigctx = ctx;
...
static int
fake_rsa_dgstsgn(void *ctx, unsigned char *sig, size_t *siglen, size_t sigsize,
                 const unsigned char *tbs, size_t tbslen)
{
...
static int
fake_rsa_dgstvfy(void *ctx, unsigned char *sig, size_t siglen, const unsigned char *tbv,
                 size_t tbvlen)
{
...
static int
fake_rsa_st_load(void *loaderctx, OSSL_CALLBACK *object_cb, void *object_cbarg,
                 OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
...
static int
fake_rsa_st_delete(void *loaderctx, const char *uri, const OSSL_PARAM params[],
                   OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
    key_deleted = 1;
    return 1;
...
static int
fake_rsa_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in,
