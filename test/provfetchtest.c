...
static int
dummy_decoder_decode(void *ctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *object_cb,
...
static int
dummy_store_load(void *loaderctx, OSSL_CALLBACK *object_cb, void *object_cbarg,
...
static const OSSL_ALGORITHM dummy_store[] = {{"DUMMY", "provider=dummy", dummy_store_functions},
                                             {NULL, NULL, NULL}};

static void *
dummy_rand_newctx(void *provctx, void *parent, const OSSL_DISPATCH *parent_calls)
{
    return provctx;
}
...
static int
dummy_rand_instantiate(void *vdrbg, unsigned int strength, int prediction_resistance,
...
static int
dummy_rand_generate(void *vctx, unsigned char *out, size_t outlen, unsigned int strength,
...
static const OSSL_ALGORITHM dummy_rand[] = {{"DUMMY", "provider=dummy", dummy_rand_functions},
                                            {NULL, NULL, NULL}};
