...
static int
test_rsa_simple(int idx, int en_pad_type, int de_pad_type, int success, unsigned char *ctext_ex,
                int *clen, RSA **retkey)
{
    int ret = 0;
    RSA *key;
...
test_rsa_oaep(int idx)
{
    ...
    if (!test_rsa_simple(idx, RSA_PKCS1_OAEP_PADDING, RSA_PKCS1_OAEP_PADDING, 1, ctext_ex, &clen,
                         &key))
        goto err;
...
test_EVP_rsa_legacy_key(void)
{
    ...
    unsigned char n_data[] = {
        0x00, 0xc7, 0x28, 0x7a, 0x28, 0x91, 0x51, 0xa5, 0xe8, 0x3c, 0x45, 0xcf, 0x1d, 0xa9, 0x69,
        0x7a, 0x0d, 0xdb, 0xdd, 0x8f, 0xe2, 0xde, 0x85, 0xdd, 0x85, 0x6d, 0x8f, 0x78, 0x20, 0xd6,
        0xe,  };

    unsigned char e_data[] = {0x01, 0x00, 0x01};

    unsigned char d_data[] = {
        };

    unsigned char p_data[] = {
        0x00, 0xed, 0xf7, 0xa7, 0x00, 0x5a, 0xbb, 0xd1, 0x52, 0x65, 0x9b, 0xec, 0xfe, 0x27, 0x8b,
    ...
    unsigned char q_data[] = {
        0x00, 0xd6, 0x3f, 0xf5, 0xee, 0xff, 0x4d, 0x7d, 0x8c, 0x1a, 0x85, 0x5d, 0x3c, 0x4f, 0x9d,
    ...
    ret = (TEST_ptr((p = BN_bin2bn(p_data, sizeof(p_data), NULL))) &&
           ...
           TEST_ptr((md = EVP_sha256())) && TEST_ptr((ctx = EVP_MD_CTX_new())) &&
           TEST_ptr((pkey = EVP_PKEY_new())) && TEST_true(RSA_set0_factors(rsa, p, q)) &&
           TEST_true(RSA_set0_key(rsa, n, e, d)) && TEST_true(EVP_PKEY_assign_RSA(pkey, rsa)) &&
...
test_rsa_saos(void)
{
    ...
    static const unsigned char sig_mismatch[256] = {
        };
    /* The signature generated by RSA_private_encrypt of in[inlen] */
    static const unsigned char no_octet_sig[256] = {
        };
