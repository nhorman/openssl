...
#define DEFINE_SET_GET_BASE_TEST(PREFIX, SETN, GETN, DUP, FIELD, TYPE, ERR, \
                                 DEFAULT, NEW, FREE) \
        static int \
        execute_CTX_ ## SETN ## _ ## GETN ## _ ## FIELD( \
            OSSL_CMP_CTX_TEST_FIXTURE *fixture) \
        { \
...
#define DEFINE_SET_GET_TEST(OSSL_CMP, CTX, N, M, DUP, FIELD, TYPE) \
        DEFINE_SET_GET_BASE_TEST(OSSL_CMP ## _ ## CTX, set ## N, get ## M, DUP, \
                                 FIELD, \
                                 TYPE *, NULL, IS_0, \
...
#define DEFINE_SET_GET_SK_TEST_DEFAULT(OSSL_CMP, CTX, N, M, FIELD, ELEM_TYPE, \
                                       DEFAULT, NEW, FREE) \
        DEFINE_SET_GET_BASE_TEST(OSSL_CMP ## _ ## CTX, set ## N, get ## M, 1, \
                                 FIELD, \
...
#define DEFINE_SET_GET_ARG_FN(SETN, GETN, FIELD, ARG, T) \
        static int OSSL_CMP_CTX_ ## SETN ## _ ## FIELD ## _ ## ARG(CMP_CTX *ctx, \
                                                                   T val) \
        { \
            return OSSL_CMP_CTX_ ## SETN ## _ ## FIELD(ctx, ARG, val); \
        } \
    \
        static T OSSL_CMP_CTX_ ## GETN ## _ ## FIELD ## _ ## ARG( \
            const CMP_CTX *ctx) \
        { \
...
#define DEFINE_SET_GET1_STR_FN(SETN, FIELD) \
        static int OSSL_CMP_CTX_ ## SETN ## _ ## FIELD ## _str(CMP_CTX *ctx, \
                                                               char *val) \
        { \
            return OSSL_CMP_CTX_ ## SETN ## _ ## FIELD(ctx, \
                                                       (unsigned char *)val, \
                                                       strlen(val));              \
        } \
    \
...
#define DEFINE_PUSH_BASE_TEST(PUSHN, DUP, FIELD, ELEM, TYPE, T, \
        ...
        { \
            return sk_ ## T ## _value(ctx->FIELD, sk_ ## T ## _num( \
                                          ctx->FIELD) - 1); \
        } \
\
        ...
        { \
            ...
            int (*push_fn)(CMP_CTX *ctx, TYPE) = \
                (int (*)(CMP_CTX *ctx, \
                         TYPE)) OSSL_CMP_CTX_ ## PUSHN ## _ ## ELEM; \
            /* \
