...
static void *
fake_rand_newctx(void *provctx, void *parent, const OSSL_DISPATCH *parent_dispatch)
{
...
static int
fake_rand_generate(void *vrng, unsigned char *out, size_t outlen, unsigned int strength,
...
static const OSSL_ALGORITHM fake_rand_rand[] = {{"FAKE", "provider=fake", fake_rand_functions},
                                                {NULL, NULL, NULL}};
...
static int
fake_rand_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in,
...
void
fake_rand_set_callback(EVP_RAND_CTX *rng, int (*cb)(unsigned char *out, size_t outlen,
