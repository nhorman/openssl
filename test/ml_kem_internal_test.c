...
static uint8_t ml_kem_public_entropy[] = {
    ...
    0x4e, 0x6f, 0x74, 0x20, 0x74, 0x68, 0x65, 0x20, 0x64, 0x72, 0x6f, 0x69, 0x64, 0x73, 0x20, 0x79,
...
sanity_test(void)
{
    ...
    for (i = 0; i < (int)OSSL_NELEM(alg); ++i) {
        ...
        params[0] = OSSL_PARAM_construct_octet_string(
            OSSL_RAND_PARAM_TEST_ENTROPY, ml_kem_private_entropy, sizeof(ml_kem_private_entropy));
        ...
        params[0] = OSSL_PARAM_construct_octet_string(
            OSSL_RAND_PARAM_TEST_ENTROPY, ml_kem_public_entropy, sizeof(ml_kem_public_entropy));
        ...
        ret2 = -7;
        if (!ossl_ml_kem_decap(shared_secret2, sizeof(shared_secret2), ciphertext, v->ctext_bytes,
                               private_key))
            goto done;
        ...
        if (!TEST_true(ossl_ml_kem_decap(shared_secret2, sizeof(shared_secret2), ciphertext,
         ...
         */
        if (!TEST_false(ossl_ml_kem_decap(shared_secret2, sizeof(shared_secret2), ciphertext,
