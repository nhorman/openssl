...
static int
do_sendmmsg(BIO *b, BIO_MSG *msg, size_t num_msg, uint64_t flags, size_t *num_processed)
{
    size_t done;
...
static int
do_recvmmsg(BIO *b, BIO_MSG *msg, size_t num_msg, uint64_t flags, size_t *num_processed)
{
    size_t done;
...
test_bio_dgram_impl(int af, int use_local)
{
    ...
    BIO *b1 = NULL, *b2 = NULL;
    int fd1 = -1, fd2 = -1;
    BIO_ADDR *addr1 = NULL, *addr2 = NULL, *addr3 = NULL, *addr4 = NULL, *addr5 = NULL,
             *addr6 = NULL;
    struct in_addr ina;
# if OPENSSL_USE_IPV6
