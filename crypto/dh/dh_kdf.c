...
int
ossl_dh_kdf_X9_42_asn1(unsigned char *out, size_t outlen, const unsigned char *Z, size_t Zlen,
...
int
DH_KDF_X9_42(unsigned char *out, size_t outlen, const unsigned char *Z, size_t Zlen,
