...
SHA3_absorb(uint64_t A[5][5], const unsigned char *inp, size_t len, size_t r)
{
    ...
    while (len >= r) {
        for (i = 0; i < w; i++) {
            uint64_t Ai = (uint64_t)inp[0] | (uint64_t)inp[1] << 8 | (uint64_t)inp[2] << 16 |
                          (uint64_t)inp[3] << 24 | (uint64_t)inp[4] << 32 | (uint64_t)inp[5] << 40 |
...
void
SHA3_sponge(const unsigned char *inp, size_t len, unsigned char *out, size_t d, size_t r)
{
    uint64_t A[5][5];
...
main(void)
{
    ...
    static const unsigned char result[512] = {
        };
