...
sc_subx(curve448_scalar_t out, const c448_word_t accum[C448_SCALAR_LIMBS],
        const curve448_scalar_t sub, const curve448_scalar_t p, c448_word_t extra)
{
...
static void
sc_montmul(curve448_scalar_t out, const curve448_scalar_t a, const curve448_scalar_t b)
{
    unsigned int i, j;
...
scalar_decode_short(curve448_scalar_t s, const unsigned char *ser, size_t nbytes)
{
    size_t i, j, k = 0;
...
c448_error_t
ossl_curve448_scalar_decode(curve448_scalar_t s, const unsigned char ser[C448_SCALAR_BYTES])
{
    unsigned int i;
...
void
ossl_curve448_scalar_decode_long(curve448_scalar_t s, const unsigned char *ser, size_t ser_len)
{
    size_t i;
...
void
ossl_curve448_scalar_encode(unsigned char ser[C448_SCALAR_BYTES], const curve448_scalar_t s)
{
