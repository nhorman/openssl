 ...
 * out (out): Deserialized form.
 */
void ossl_curve448_scalar_decode_long(curve448_scalar_t out, const unsigned char *ser,
                                      size_t ser_len);
 ...
 */
void ossl_curve448_point_mul_by_ratio_and_encode_like_x448(uint8_t out[X448_PUBLIC_BYTES],
