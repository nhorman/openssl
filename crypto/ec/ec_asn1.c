...
ASN1_SEQUENCE(X9_62_PENTANOMIAL) = {ASN1_EMBED(X9_62_PENTANOMIAL, k1, INT32),
    ...
    {ADB_ENTRY(NID_X9_62_prime_field, ASN1_SIMPLE(X9_62_FIELDID, p.prime, ASN1_INTEGER)),
     ADB_ENTRY(NID_X9_62_characteristic_two_field,
               ASN1_SIMPLE(X9_62_FIELDID, p.char_two,
                           X9_62_CHARACTERISTIC_TWO))} ASN1_ADB_END(X9_62_FIELDID, 0, fieldType, 0,
                                                                    &fieldID_def_tt, NULL);
                                    ...
                                    {ASN1_EMBED(EC_PRIVATEKEY, version, INT32),
                                     ...
                                     ASN1_EXP_OPT(EC_PRIVATEKEY, publicKey, ASN1_BIT_STRING,
                                        ...
                                        DECLARE_ASN1_FUNCTIONS(EC_PRIVATEKEY)
                                            DECLARE_ASN1_ENCODE_FUNCTIONS_name(EC_PRIVATEKEY,
                                                                               EC_PRIVATEKEY)
