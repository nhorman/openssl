...
static BIGNUM *
srp_Calc_xy(const BIGNUM *x, const BIGNUM *y, const BIGNUM *N, OSSL_LIB_CTX *libctx,
            const char *propq)
{
...
static BIGNUM *
srp_Calc_k(const BIGNUM *N, const BIGNUM *g, OSSL_LIB_CTX *libctx, const char *propq)
{
...
BIGNUM *
SRP_Calc_u_ex(const BIGNUM *A, const BIGNUM *B, const BIGNUM *N, OSSL_LIB_CTX *libctx,
              const char *propq)
{
...
BIGNUM *
SRP_Calc_server_key(const BIGNUM *A, const BIGNUM *v, const BIGNUM *u, const BIGNUM *b,
                    const BIGNUM *N)
{
...
BIGNUM *
SRP_Calc_B_ex(const BIGNUM *b, const BIGNUM *N, const BIGNUM *g, const BIGNUM *v,
...
BIGNUM *
SRP_Calc_x_ex(const BIGNUM *s, const char *user, const char *pass, OSSL_LIB_CTX *libctx,
              const char *propq)
{
...
BIGNUM *
SRP_Calc_client_key_ex(const BIGNUM *N, const BIGNUM *B, const BIGNUM *g, const BIGNUM *x,
...
BIGNUM *
SRP_Calc_client_key(const BIGNUM *N, const BIGNUM *B, const BIGNUM *g, const BIGNUM *x,
