...
static EVP_PKEY *
pkey_type2param(int ptype, const void *pval, OSSL_LIB_CTX *libctx, const char *propq)
{
    EVP_PKEY *pkey = NULL;
...
static int
ecdh_cms_set_peerkey(EVP_PKEY_CTX *pctx, X509_ALGOR *alg, ASN1_BIT_STRING *pubkey)
{
...
ecdh_cms_encrypt(CMS_RecipientInfo *ri)
{
    ...
    if (aoid == OBJ_nid2obj(NID_undef)) {
        ...
        penc = NULL;
        (void)X509_ALGOR_set0(talg, OBJ_nid2obj(NID_X9_62_id_ecPublicKey), V_ASN1_UNDEF,
                              NULL); /* cannot fail */
    }
