...
CMS_ContentInfo *
CMS_data_create_ex(BIO *in, unsigned int flags, OSSL_LIB_CTX *libctx, const char *propq)
{
...
CMS_ContentInfo *
CMS_digest_create_ex(BIO *in, const EVP_MD *md, unsigned int flags, OSSL_LIB_CTX *ctx,
                     const char *propq)
{
    CMS_ContentInfo *cms;
...
int
CMS_EncryptedData_decrypt(CMS_ContentInfo *cms, const unsigned char *key, size_t keylen, BIO *dcont,
...
CMS_ContentInfo *
CMS_EncryptedData_encrypt_ex(BIO *in, const EVP_CIPHER *cipher, const unsigned char *key,
...
CMS_ContentInfo *
CMS_EncryptedData_encrypt(BIO *in, const EVP_CIPHER *cipher, const unsigned char *key,
...
static int
cms_signerinfo_verify_cert(CMS_SignerInfo *si, X509_STORE *store, STACK_OF(X509) * untrusted,
                           ...
                           const CMS_CTX *cms_ctx)
{
    ...
    ctx =
        X509_STORE_CTX_new_ex(ossl_cms_ctx_get0_libctx(cms_ctx), ossl_cms_ctx_get0_propq(cms_ctx));
    if (ctx == NULL) {
...
int
CMS_verify(CMS_ContentInfo *cms, STACK_OF(X509) * certs, X509_STORE *store, BIO *dcont, BIO *out,
           unsigned int flags)
{
    CMS_SignerInfo *si;
...
int
CMS_verify_receipt(CMS_ContentInfo *rcms, CMS_ContentInfo *ocms, STACK_OF(X509) * certs,
...
CMS_ContentInfo *
CMS_sign_ex(X509 *signcert, EVP_PKEY *pkey, STACK_OF(X509) * certs, BIO *data, unsigned int flags,
...
CMS_ContentInfo *
CMS_sign_receipt(CMS_SignerInfo *si, X509 *signcert, EVP_PKEY *pkey, STACK_OF(X509) * certs,
                 unsigned int flags)
{
    ...
    cms = CMS_sign_ex(NULL, NULL, certs, NULL, flags, ossl_cms_ctx_get0_libctx(ctx),
...
CMS_ContentInfo *
CMS_encrypt_ex(STACK_OF(X509) * certs, BIO *data, const EVP_CIPHER *cipher, unsigned int flags,
               OSSL_LIB_CTX *libctx, const char *propq)
{
    CMS_ContentInfo *cms;
    int i;
...
CMS_ContentInfo *
CMS_encrypt(STACK_OF(X509) * certs, BIO *data, const EVP_CIPHER *cipher, unsigned int flags)
{
    return CMS_encrypt_ex(certs, data, cipher, flags, NULL, NULL);
}

static int
cms_kari_set1_pkey_and_peer(CMS_ContentInfo *cms, CMS_RecipientInfo *ri, EVP_PKEY *pk, X509 *cert,
                            X509 *peer)
{
    int i;
...
int
CMS_decrypt_set1_pkey_and_peer(CMS_ContentInfo *cms, EVP_PKEY *pk, X509 *cert, X509 *peer)
{
...
int
CMS_decrypt_set1_password(CMS_ContentInfo *cms, unsigned char *pass, ossl_ssize_t passlen)
{
    STACK_OF(CMS_RecipientInfo) *ris = CMS_get0_RecipientInfos(cms);
    CMS_RecipientInfo *ri;
    int i, r, match_ri = 0;
...
int
CMS_decrypt(CMS_ContentInfo *cms, EVP_PKEY *pk, X509 *cert, BIO *dcont, BIO *out,
            unsigned int flags)
{
    int r;
    BIO *cont;
...
int
CMS_final_digest(CMS_ContentInfo *cms, const unsigned char *md, unsigned int mdlen, BIO *dcont,
                 unsigned int flags)
{
    BIO *cmsbio;
    int ret = 0;
