...
void *
evp_skeymgmt_import(const EVP_SKEYMGMT *skeymgmt, int selection, const OSSL_PARAM params[])
{
    void *provctx = ossl_provider_ctx(EVP_SKEYMGMT_get0_provider(skeymgmt));
...
int
evp_skeymgmt_export(const EVP_SKEYMGMT *skeymgmt, void *keydata, int selection,
...
static void *
skeymgmt_from_algorithm(int name_id, const OSSL_ALGORITHM *algodef, OSSL_PROVIDER *prov)
{
...
EVP_SKEYMGMT *
evp_skeymgmt_fetch_from_prov(OSSL_PROVIDER *prov, const char *name, const char *properties)
{
...
EVP_SKEYMGMT *
EVP_SKEYMGMT_fetch(OSSL_LIB_CTX *ctx, const char *algorithm, const char *properties)
{
...
void
EVP_SKEYMGMT_do_all_provided(OSSL_LIB_CTX *libctx, void (*fn)(EVP_SKEYMGMT *skeymgmt, void *arg),
                             void *arg)
{
...
int
EVP_SKEYMGMT_names_do_all(const EVP_SKEYMGMT *skeymgmt, void (*fn)(const char *name, void *data),
                          void *data)
{
    if (skeymgmt == NULL)
        return 0;
