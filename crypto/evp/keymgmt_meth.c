...
static void *
keymgmt_from_algorithm(int name_id, const OSSL_ALGORITHM *algodef, OSSL_PROVIDER *prov)
{
...
EVP_KEYMGMT *
evp_keymgmt_fetch_from_prov(OSSL_PROVIDER *prov, const char *name, const char *properties)
{
...
EVP_KEYMGMT *
EVP_KEYMGMT_fetch(OSSL_LIB_CTX *ctx, const char *algorithm, const char *properties)
{
    return evp_generic_fetch(ctx, OSSL_OP_KEYMGMT, algorithm, properties, keymgmt_from_algorithm,
...
void
EVP_KEYMGMT_do_all_provided(OSSL_LIB_CTX *libctx, void (*fn)(EVP_KEYMGMT *keymgmt, void *arg),
                            void *arg)
{
    evp_generic_do_all(libctx, OSSL_OP_KEYMGMT, (void (*)(void *, void *))fn, arg,
                       keymgmt_from_algorithm, evp_keymgmt_up_ref, evp_keymgmt_free);
}

int
EVP_KEYMGMT_names_do_all(const EVP_KEYMGMT *keymgmt, void (*fn)(const char *name, void *data),
                         void *data)
{
...
void *
evp_keymgmt_gen_init(const EVP_KEYMGMT *keymgmt, int selection, const OSSL_PARAM params[])
{
    void *provctx = ossl_provider_ctx(EVP_KEYMGMT_get0_provider(keymgmt));
...
int
evp_keymgmt_gen_set_template(const EVP_KEYMGMT *keymgmt, void *genctx, void *templ)
{
    /*
...
int
evp_keymgmt_gen_set_params(const EVP_KEYMGMT *keymgmt, void *genctx, const OSSL_PARAM params[])
{
    if (keymgmt->gen_set_params == NULL)
        return 0;
...
int
evp_keymgmt_gen_get_params(const EVP_KEYMGMT *keymgmt, void *genctx, OSSL_PARAM params[])
{
    if (keymgmt->gen_get_params == NULL)
        return 0;
...
void *
evp_keymgmt_gen(const EVP_KEYMGMT *keymgmt, void *genctx, OSSL_CALLBACK *cb, void *cbarg)
{
    if (keymgmt->gen == NULL)
        return NULL;
...
void *
evp_keymgmt_load(const EVP_KEYMGMT *keymgmt, const void *objref, size_t objref_sz)
{
...
int
evp_keymgmt_get_params(const EVP_KEYMGMT *keymgmt, void *keydata, OSSL_PARAM params[])
{
    if (keymgmt->get_params == NULL)
        return 1;
...
int
evp_keymgmt_set_params(const EVP_KEYMGMT *keymgmt, void *keydata, const OSSL_PARAM params[])
{
    if (keymgmt->set_params == NULL)
        return 1;
...
int
evp_keymgmt_validate(const EVP_KEYMGMT *keymgmt, void *keydata, int selection, int checktype)
{
...
int
evp_keymgmt_match(const EVP_KEYMGMT *keymgmt, const void *keydata1, const void *keydata2,
                  int selection)
{
...
void *
evp_keymgmt_dup(const EVP_KEYMGMT *keymgmt, const void *keydata_from, int selection)
{
