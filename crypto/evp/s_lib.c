...
int
EVP_SKEY_export(const EVP_SKEY *skey, int selection, OSSL_CALLBACK *export_cb, void *export_cbarg)
{
    if (skey == NULL) {
...
static EVP_SKEY *
evp_skey_alloc_fetch(OSSL_LIB_CTX *libctx, const char *skeymgmtname, const char *propquery)
{
...
EVP_SKEY *
EVP_SKEY_import(OSSL_LIB_CTX *libctx, const char *skeymgmtname, const char *propquery,
...
EVP_SKEY *
EVP_SKEY_generate(OSSL_LIB_CTX *libctx, const char *skeymgmtname, const char *propquery,
...
int
EVP_SKEY_get0_raw_key(const EVP_SKEY *skey, const unsigned char **key, size_t *len)
{
...
EVP_SKEY *
EVP_SKEY_import_raw_key(OSSL_LIB_CTX *libctx, const char *skeymgmtname, unsigned char *key,
                        size_t keylen, const char *propquery)
{
    ...
    return EVP_SKEY_import(libctx, skeymgmtname, propquery, OSSL_SKEYMGMT_SELECT_SECRET_KEY,
                           params);
}
...
EVP_SKEY *
EVP_SKEY_to_provider(EVP_SKEY *skey, OSSL_LIB_CTX *libctx, OSSL_PROVIDER *prov,
