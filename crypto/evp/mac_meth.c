...
static void *
evp_mac_from_algorithm(int name_id, const OSSL_ALGORITHM *algodef, OSSL_PROVIDER *prov)
{
...
EVP_MAC *
EVP_MAC_fetch(OSSL_LIB_CTX *libctx, const char *algorithm, const char *properties)
{
    return evp_generic_fetch(libctx, OSSL_OP_MAC, algorithm, properties, evp_mac_from_algorithm,
...
void
EVP_MAC_do_all_provided(OSSL_LIB_CTX *libctx, void (*fn)(EVP_MAC *mac, void *arg), void *arg)
{
...
EVP_MAC *
evp_mac_fetch_from_prov(OSSL_PROVIDER *prov, const char *algorithm, const char *properties)
{
