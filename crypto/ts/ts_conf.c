...
int
TS_CONF_set_serial(CONF *conf, const char *section, TS_serial_cb cb, TS_RESP_CTX *ctx)
{
    int ret = 0;
...
int
TS_CONF_set_signer_cert(CONF *conf, const char *section, const char *cert, TS_RESP_CTX *ctx)
{
    int ret = 0;
    X509 *cert_obj = NULL;
...
int
TS_CONF_set_certs(CONF *conf, const char *section, const char *certs, TS_RESP_CTX *ctx)
{
    int ret = 0;
...
int
TS_CONF_set_signer_key(CONF *conf, const char *section, const char *key, const char *pass,
                       TS_RESP_CTX *ctx)
{
    int ret = 0;
...
int
TS_CONF_set_signer_digest(CONF *conf, const char *section, const char *md, TS_RESP_CTX *ctx)
{
    int ret = 0;
...
int
TS_CONF_set_def_policy(CONF *conf, const char *section, const char *policy, TS_RESP_CTX *ctx)
{
    int ret = 0;
...
int
TS_CONF_set_clock_precision_digits(const CONF *conf, const char *section, TS_RESP_CTX *ctx)
{
    int ret = 0;
    long digits = 0;
...
static int
ts_CONF_add_flag(CONF *conf, const char *section, const char *field, int flag, TS_RESP_CTX *ctx)
{
...
int
TS_CONF_set_ess_cert_id_digest(CONF *conf, const char *section, TS_RESP_CTX *ctx)
{
    int ret = 0;
