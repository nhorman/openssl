...
CRYPTO_THREAD *
ossl_crypto_thread_native_start(CRYPTO_THREAD_ROUTINE routine, void *data, int joinable)
{
...
int
ossl_crypto_thread_native_join(CRYPTO_THREAD *thread, CRYPTO_THREAD_RETVAL *retval)
{
