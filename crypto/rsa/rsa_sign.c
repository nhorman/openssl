 ...
 */
static int
encode_pkcs1(unsigned char **out, size_t *out_len, int type, const unsigned char *m, size_t m_len)
{
...
int
RSA_sign(int type, const unsigned char *m, unsigned int m_len, unsigned char *sigret,
 ...
 */
int
ossl_rsa_verify(int type, const unsigned char *m, unsigned int m_len, unsigned char *rm,
...
int
RSA_verify(int type, const unsigned char *m, unsigned int m_len, const unsigned char *sigbuf,
           unsigned int siglen, RSA *rsa)
{
