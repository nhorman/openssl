...
ASN1_SEQUENCE(X509_ALGOR) = {ASN1_SIMPLE(X509_ALGOR, algorithm, ASN1_OBJECT),
    ...
    ASN1_ITEM_TEMPLATE(X509_ALGORS) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, algorithms,
                                                            X509_ALGOR)
...
void
X509_ALGOR_get0(const ASN1_OBJECT **paobj, int *pptype, const void **ppval, const X509_ALGOR *algor)
{
    if (paobj)
