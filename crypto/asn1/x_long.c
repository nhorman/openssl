...
static int long_c2i(ASN1_VALUE **pval, const unsigned char *cont, int len, int utype,
                    char *free_cont, const ASN1_ITEM *it);
static int long_print(BIO *out, const ASN1_VALUE **pval, const ASN1_ITEM *it, int indent,
...
static int
long_i2c(const ASN1_VALUE **pval, unsigned char *cont, int *putype, const ASN1_ITEM *it)
{
    long ltmp;
...
static int
long_c2i(ASN1_VALUE **pval, const unsigned char *cont, int len, int utype, char *free_cont,
         const ASN1_ITEM *it)
{
    int i;
    long ltmp;
