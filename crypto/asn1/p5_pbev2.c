...
ASN1_SEQUENCE(PBE2PARAM) = {ASN1_SIMPLE(PBE2PARAM, keyfunc, X509_ALGOR),
    ...
    IMPLEMENT_ASN1_FUNCTIONS(PBE2PARAM)
        ...
        ASN1_SEQUENCE(PBKDF2PARAM) = {ASN1_SIMPLE(PBKDF2PARAM, salt, ASN1_ANY),
...
X509_ALGOR *
PKCS5_pbe2_set_iv(const EVP_CIPHER *cipher, int iter, unsigned char *salt, int saltlen,
...
X509_ALGOR *
PKCS5_pbe2_set(const EVP_CIPHER *cipher, int iter, unsigned char *salt, int saltlen)
{
    return PKCS5_pbe2_set_iv_ex(cipher, iter, salt, saltlen, NULL, -1, NULL);
}

X509_ALGOR *
PKCS5_pbkdf2_set_ex(int iter, unsigned char *salt, int saltlen, int prf_nid, int keylen,
                    OSSL_LIB_CTX *libctx)
{
...
X509_ALGOR *
PKCS5_pbkdf2_set(int iter, unsigned char *salt, int saltlen, int prf_nid, int keylen)
{
