...
#define TOK_CPU_ALIAS(NAME, STRUCT_NAME)                                                           \
    (sscanf(tok_begin, " %" STR(LEN) "s %" STR(LEN) "s ", tok[0], tok[1]) == 1 &&                  \
     !strcmp(tok[0], #NAME))                                                                       \
    {                                                                                              \
...
parse_env(struct OPENSSL_s390xcap_st *cap, int *cex)
{
    ...
    static const struct OPENSSL_s390xcap_st z196 = {
        ...
        /*.km     = */
        {S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_AES_128) | S390X_CAPBIT(S390X_AES_192) |
             S390X_CAPBIT(S390X_AES_256) | S390X_CAPBIT(S390X_XTS_AES_128) |
    ...
    static const struct OPENSSL_s390xcap_st z13 = {
        /*.stfle  = */ {
            S390X_CAPBIT(S390X_MSA) | S390X_CAPBIT(S390X_STCKF) | S390X_CAPBIT(S390X_MSA5),
    ...
    static const struct OPENSSL_s390xcap_st z14 = {
        ...
        /*.kimd   = */
        {S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_SHA_1) | S390X_CAPBIT(S390X_SHA_256) |
             S390X_CAPBIT(S390X_SHA_512) | S390X_CAPBIT(S390X_SHA3_224) |
             S390X_CAPBIT(S390X_SHA3_256) | S390X_CAPBIT(S390X_SHA3_384) |
             S390X_CAPBIT(S390X_SHA3_512) | S390X_CAPBIT(S390X_SHAKE_128) |
    ...
    static const struct OPENSSL_s390xcap_st z15 = {
        ...
        {S390X_CAPBIT(S390X_QUERY),
         S390X_CAPBIT(S390X_SCALAR_MULTIPLY_P256) | S390X_CAPBIT(S390X_SCALAR_MULTIPLY_P384) |
             ...
             S390X_CAPBIT(S390X_SCALAR_MULTIPLY_X25519) | S390X_CAPBIT(S390X_SCALAR_MULTIPLY_X448)},
        /*.kdsa   = */
        {S390X_CAPBIT(S390X_QUERY) | S390X_CAPBIT(S390X_ECDSA_VERIFY_P256) |
             S390X_CAPBIT(S390X_ECDSA_VERIFY_P384) | S390X_CAPBIT(S390X_ECDSA_VERIFY_P521) |
             S390X_CAPBIT(S390X_ECDSA_SIGN_P256) | S390X_CAPBIT(S390X_ECDSA_SIGN_P384) |
             S390X_CAPBIT(S390X_ECDSA_SIGN_P521) | S390X_CAPBIT(S390X_EDDSA_VERIFY_ED25519) |
             S390X_CAPBIT(S390X_EDDSA_VERIFY_ED448) | S390X_CAPBIT(S390X_EDDSA_SIGN_ED25519) |
    ...
    while (tok_begin != NULL) {
        ...
        /* query function tokens */
                ...
                else if (sscanf(tok_begin, " %" STR(LEN) "s %" STR(LEN) "s ", tok[0], tok[1]) ==
                             1 &&
                         !strcmp(tok[0], "nocex"))
            {
                *cex = 0;
