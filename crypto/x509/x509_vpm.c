...
static int
int_x509_param_set_hosts(X509_VERIFY_PARAM *vpm, int mode, const char *name, size_t namelen)
{
    char *copy;
...
static int
int_x509_param_set1(char **pdest, size_t *pdestlen, const char *src, size_t srclen)
{
    char *tmp;
