...
int
X509v3_get_ext_by_OBJ(const STACK_OF(X509_EXTENSION) * sk, const ASN1_OBJECT *obj, int lastpos)
{
    int n;
    X509_EXTENSION *ex;
...
int
X509v3_get_ext_by_critical(const STACK_OF(X509_EXTENSION) * sk, int crit, int lastpos)
{
    int n, c;
    X509_EXTENSION *ex;
...
STACK_OF(X509_EXTENSION) *
    X509v3_add_extensions(STACK_OF(X509_EXTENSION) * *target, const STACK_OF(X509_EXTENSION) * exts)
{
    int i;
...
X509_EXTENSION *
X509_EXTENSION_create_by_OBJ(X509_EXTENSION **ex, const ASN1_OBJECT *obj, int crit,
