...
static int by_file_ctrl_ex(X509_LOOKUP *ctx, int cmd, const char *argc, long argl, char **ret,
...
static int
by_file_ctrl_ex(X509_LOOKUP *ctx, int cmd, const char *argp, long argl, char **ret,
                OSSL_LIB_CTX *libctx, const char *propq)
{
    int ok = 0;
    const char *file;
...
int
X509_load_cert_file_ex(X509_LOOKUP *ctx, const char *file, int type, OSSL_LIB_CTX *libctx,
                       const char *propq)
{
    BIO *in = NULL;
    int count = 0;
...
int
X509_load_cert_crl_file_ex(X509_LOOKUP *ctx, const char *file, int type, OSSL_LIB_CTX *libctx,
                           const char *propq)
{
