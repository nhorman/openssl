...
void
OSSL_IETF_ATTR_SYNTAX_set0_policyAuthority(OSSL_IETF_ATTR_SYNTAX *a, GENERAL_NAMES *names)
{
...
void *
OSSL_IETF_ATTR_SYNTAX_get0_value(const OSSL_IETF_ATTR_SYNTAX *a, int ind, int *type)
{
    OSSL_IETF_ATTR_SYNTAX_VALUE *val;
