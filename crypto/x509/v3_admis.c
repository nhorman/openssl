                        ...
                        ASN1_SEQUENCE(ADMISSION_SYNTAX) =
                            {
                                ...
                                ASN1_SEQUENCE_OF(ADMISSION_SYNTAX, contentsOfAdmissions,
                                                 ADMISSIONS),
                                        ...
                                        IMPLEMENT_ASN1_FUNCTIONS(ADMISSIONS)
                                            IMPLEMENT_ASN1_FUNCTIONS(ADMISSION_SYNTAX)
                                                ...
                                                static int i2r_ADMISSION_SYNTAX(
                                                    const struct v3_ext_method *method, void *in,
                                                    BIO *bp, int ind);
...
static int
i2r_NAMING_AUTHORITY(const struct v3_ext_method *method, void *in, BIO *bp, int ind)
{
    ...
    if (namingAuthority->namingAuthorityId == NULL &&
        namingAuthority->namingAuthorityText == NULL && namingAuthority->namingAuthorityUrl == NULL)
        return 0;
...
static int
i2r_ADMISSION_SYNTAX(const struct v3_ext_method *method, void *in, BIO *bp, int ind)
{
...
void
ADMISSION_SYNTAX_set0_contentsOfAdmissions(ADMISSION_SYNTAX *as, STACK_OF(ADMISSIONS) * a)
{
...
void
PROFESSION_INFO_set0_addProfessionInfo(PROFESSION_INFO *pi, ASN1_OCTET_STRING *aos)
{
...
void
PROFESSION_INFO_set0_professionItems(PROFESSION_INFO *pi, STACK_OF(ASN1_STRING) * as)
{
...
void
PROFESSION_INFO_set0_professionOIDs(PROFESSION_INFO *pi, STACK_OF(ASN1_OBJECT) * po)
{
...
void
PROFESSION_INFO_set0_registrationNumber(PROFESSION_INFO *pi, ASN1_PRINTABLESTRING *rn)
{
