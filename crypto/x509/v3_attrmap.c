                    ...
                    ASN1_CHOICE(OSSL_ATTRIBUTE_MAPPING) =
                        {
                            ...
                            ASN1_ITEM_TEMPLATE(OSSL_ATTRIBUTE_MAPPINGS) = ASN1_EX_TEMPLATE_TYPE(
                                ...
                                ASN1_ITEM_TEMPLATE_END(OSSL_ATTRIBUTE_MAPPINGS)
                                    ...
                                    IMPLEMENT_ASN1_FUNCTIONS(OSSL_ATAV) IMPLEMENT_ASN1_FUNCTIONS(
                                        ...
                                        IMPLEMENT_ASN1_FUNCTIONS(OSSL_ATTRIBUTE_VALUE_MAPPING)
                                            IMPLEMENT_ASN1_FUNCTIONS(OSSL_ATTRIBUTE_MAPPING)
                                                IMPLEMENT_ASN1_FUNCTIONS(OSSL_ATTRIBUTE_MAPPINGS)
                                                    ...
                                                    static int i2r_ATTRIBUTE_MAPPING(
...
static int
i2r_ATTRIBUTE_MAPPINGS(X509V3_EXT_METHOD *method, OSSL_ATTRIBUTE_MAPPINGS *ams, BIO *out,
                       int indent)
{
    int i;
