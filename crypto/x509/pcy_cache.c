...
X509_POLICY_DATA *
ossl_policy_cache_find_data(const X509_POLICY_CACHE *cache, const ASN1_OBJECT *id)
{
    int idx;
...
static int
policy_data_cmp(const X509_POLICY_DATA *const *a, const X509_POLICY_DATA *const *b)
{
