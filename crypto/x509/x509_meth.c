...
int
X509_LOOKUP_meth_set_new_item(X509_LOOKUP_METHOD *method, int (*new_item)(X509_LOOKUP *ctx))
{
...
int
X509_LOOKUP_meth_set_free(X509_LOOKUP_METHOD *method, void (*free_fn)(X509_LOOKUP *ctx))
{
    method->free = free_fn;
    return 1;
}
...
int
X509_LOOKUP_meth_set_init(X509_LOOKUP_METHOD *method, int (*init)(X509_LOOKUP *ctx))
{
    method->init = init;
    return 1;
}
...
int
X509_LOOKUP_meth_set_shutdown(X509_LOOKUP_METHOD *method, int (*shutdown)(X509_LOOKUP *ctx))
{
...
int
X509_LOOKUP_meth_set_get_by_subject(X509_LOOKUP_METHOD *method,
...
int
X509_LOOKUP_meth_set_get_by_issuer_serial(X509_LOOKUP_METHOD *method,
...
int
X509_LOOKUP_meth_set_get_by_fingerprint(X509_LOOKUP_METHOD *method,
