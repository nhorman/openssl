...
void
DES_encrypt3(DES_LONG *data, DES_key_schedule *ks1, DES_key_schedule *ks2, DES_key_schedule *ks3)
{
...
void
DES_ede3_cbc_encrypt(const unsigned char *input, unsigned char *output, long length,
