...
ASN1_SEQUENCE(OCSP_SIGNATURE) = {ASN1_EMBED(OCSP_SIGNATURE, signatureAlgorithm, X509_ALGOR),
    ...
    ASN1_SEQUENCE(
        OCSP_RESPBYTES) = {ASN1_SIMPLE(OCSP_RESPBYTES, responseType, ASN1_OBJECT),
                           ASN1_SIMPLE(OCSP_RESPBYTES, response,
                                       ASN1_OCTET_STRING)} ASN1_SEQUENCE_END(OCSP_RESPBYTES)

        IMPLEMENT_ASN1_FUNCTIONS(OCSP_RESPBYTES)

            ASN1_SEQUENCE(OCSP_RESPONSE) = {ASN1_SIMPLE(OCSP_RESPONSE, responseStatus,
                                                        ASN1_ENUMERATED),
                                            ASN1_EXP_OPT(OCSP_RESPONSE, responseBytes,
                                                         OCSP_RESPBYTES,
                    ...
                    ASN1_CHOICE(OCSP_RESPID) = {ASN1_EXP(OCSP_RESPID, value.byName, X509_NAME, 1),
                        ...
                        IMPLEMENT_ASN1_FUNCTIONS(OCSP_RESPID)
                            ...
                            ASN1_SEQUENCE(OCSP_REVOKEDINFO) =
                                {ASN1_SIMPLE(OCSP_REVOKEDINFO, revocationTime,
                                    ...
                                    IMPLEMENT_ASN1_FUNCTIONS(OCSP_REVOKEDINFO)
                                        ...
                                        ASN1_CHOICE(
                                            OCSP_CERTSTATUS) = {ASN1_IMP(OCSP_CERTSTATUS,
                                                                         value.good, ASN1_NULL, 0),
                                                                ASN1_IMP(OCSP_CERTSTATUS,
                                                                         value.revoked,
                                                                         OCSP_REVOKEDINFO, 1),
                                                                ASN1_IMP(OCSP_CERTSTATUS,
                                                                         value.unknown, ASN1_NULL,
                                            ...
                                            IMPLEMENT_ASN1_FUNCTIONS(OCSP_CERTSTATUS)
                                                ...
                                                ASN1_SEQUENCE(OCSP_SINGLERESP) =
                                                    {ASN1_SIMPLE(
                                                         OCSP_SINGLERESP, certId, OCSP_CERTID),
                                                     ASN1_SIMPLE(
                                                     ...
                                                     ASN1_SIMPLE(
                                                         ...
                                                         ASN1_GENERALIZEDTIME),
                                                     ASN1_EXP_OPT(OCSP_SINGLERESP, nextUpdate,
                                                                  ASN1_GENERALIZEDTIME, 0),
                                                     ASN1_EXP_SEQUENCE_OF_OPT(
                                                        ...
                                                        IMPLEMENT_ASN1_FUNCTIONS(OCSP_SINGLERESP)
                                                            ...
                                                            ASN1_SEQUENCE(OCSP_RESPDATA) =
                                                                {ASN1_EXP_OPT(OCSP_RESPDATA,
                                                                              version, ASN1_INTEGER,
                                                                              0),
                                                                 ASN1_EMBED(
                                                                     OCSP_RESPDATA,
                                                                     responderId, OCSP_RESPID),
                                                                 ASN1_SIMPLE(
                                                                     OCSP_RESPDATA,
                                                                     producedAt,
                                                                     ASN1_GENERALIZEDTIME),
                                                                 ASN1_SEQUENCE_OF(OCSP_RESPDATA,
                                                                                  responses,
                                                                                  OCSP_SINGLERESP),
                                                                 ASN1_EXP_SEQUENCE_OF_OPT(
                                                                     OCSP_RESPDATA,
