...
int
ossl_sm2_compute_z_digest(uint8_t *out, const EVP_MD *digest, const uint8_t *id,
...
static BIGNUM *
sm2_compute_msg_hash(const EVP_MD *digest, const EC_KEY *key, const uint8_t *id,
...
ECDSA_SIG *
ossl_sm2_do_sign(const EC_KEY *key, const EVP_MD *digest, const uint8_t *id, const size_t id_len,
...
int
ossl_sm2_do_verify(const EC_KEY *key, const EVP_MD *digest, const ECDSA_SIG *sig, const uint8_t *id,
                   const size_t id_len, const uint8_t *msg, size_t msg_len)
{
    BIGNUM *e = NULL;
    int ret = 0;
...
int
ossl_sm2_internal_sign(const unsigned char *dgst, int dgstlen, unsigned char *sig,
...
int
ossl_sm2_internal_verify(const unsigned char *dgst, int dgstlen, const unsigned char *sig,
