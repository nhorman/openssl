 ...
 */
int
ossl_method_store_add(OSSL_METHOD_STORE *store, const OSSL_PROVIDER *prov, int nid,
...
int
ossl_method_store_remove_all_provided(OSSL_METHOD_STORE *store, const OSSL_PROVIDER *prov)
{
...
static void
alg_do_one(ALGORITHM *alg, IMPLEMENTATION *impl, void (*fn)(int id, void *method, void *fnarg),
           void *fnarg)
{
...
void
ossl_method_store_do_all(OSSL_METHOD_STORE *store, void (*fn)(int id, void *method, void *fnarg),
                         void *fnarg)
{
    int i, j;
    int numalgs, numimps;
 ...
 */
int
ossl_method_store_fetch(OSSL_METHOD_STORE *store, int nid, const char *prop_query,
...
int
ossl_method_store_cache_get(OSSL_METHOD_STORE *store, OSSL_PROVIDER *prov, int nid,
...
int
ossl_method_store_cache_set(OSSL_METHOD_STORE *store, OSSL_PROVIDER *prov, int nid,
