...
void ossl_rsaz_amm52x20_x1_ifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b,
                                   const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x20_x2_ifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b,
                                   const BN_ULONG *m, const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x20_win5(BN_ULONG *red_Y, const BN_ULONG *red_table,
                                       int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x30_x1_ifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b,
                                   const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x30_x2_ifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b,
                                   const BN_ULONG *m, const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x30_win5(BN_ULONG *red_Y, const BN_ULONG *red_table,
                                       int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x40_x1_ifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b,
                                   const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x40_x2_ifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b,
                                   const BN_ULONG *m, const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x40_win5(BN_ULONG *red_Y, const BN_ULONG *red_table,
                                       int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x20_x1_avxifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b,
                                      const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x20_x2_avxifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b,
                                      const BN_ULONG *m, const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x20_win5_avx(BN_ULONG *red_Y, const BN_ULONG *red_table,
                                           int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x30_x1_avxifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b,
                                      const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x30_x2_avxifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b,
                                      const BN_ULONG *m, const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x30_win5_avx(BN_ULONG *red_Y, const BN_ULONG *red_table,
                                           int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x40_x1_avxifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b,
                                      const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x40_x2_avxifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b,
                                      const BN_ULONG *m, const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x40_win5_avx(BN_ULONG *red_Y, const BN_ULONG *red_table,
                                           int red_table_idx1, int red_table_idx2);

typedef void (*AMM)(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                    BN_ULONG k0);
...
typedef void (*DAMM)(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                     const BN_ULONG k0[2]);
...
static int RSAZ_mod_exp_x2_ifma256(BN_ULONG *res, const BN_ULONG *base, const BN_ULONG *exp[2],
                                   const BN_ULONG *m, const BN_ULONG *rr, const BN_ULONG k0[2],
                                   int modulus_bitsize);
 ...
 */
int
ossl_rsaz_mod_exp_avx512_x2(BN_ULONG *res1, const BN_ULONG *base1, const BN_ULONG *exp1,
                            const BN_ULONG *m1, const BN_ULONG *rr1, BN_ULONG k0_1, BN_ULONG *res2,
                            const BN_ULONG *base2, const BN_ULONG *exp2, const BN_ULONG *m2,
                            const BN_ULONG *rr2, BN_ULONG k0_2, int factor_size)
{
    int ret = 0;
 ...
 */
int
RSAZ_mod_exp_x2_ifma256(BN_ULONG *out, const BN_ULONG *base, const BN_ULONG *exp[2],
                        const BN_ULONG *m, const BN_ULONG *rr, const BN_ULONG k0[2],
                        int modulus_bitsize)
{
    int ret = 0;
...
# define DAMS(r, a, m, k0) damm((r), (a), (a), (m), (k0))
    ...
    for (idx = 1; idx < (int)((1U << exp_win_size) / 2); idx++) {
        DAMS(&red_table[(2 * idx + 0) * 2 * red_digits], &red_table[(1 * idx) * 2 * red_digits], m,
             k0);
    ...
    /* Exponentiation */
    {
        ...
        extract(&red_Y[0 * red_digits], (const BN_ULONG *)red_table, (int)red_table_idx_0,
                (int)red_table_idx_1);
