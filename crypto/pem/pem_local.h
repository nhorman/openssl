...
#define IMPLEMENT_PEM_provided_write_body_vars(type, asn1, pq)                                     \
    int ret = 0;                                                                                   \
    OSSL_ENCODER_CTX *ctx = OSSL_ENCODER_CTX_new_for_##type(x, PEM_SELECTION_##asn1, "PEM",        \
                                                            PEM_STRUCTURE_##asn1, (pq));           \
                                                                                                   \
...
#define IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, OUTTYPE, outtype,          \
                                           writename)                                              \
