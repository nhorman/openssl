...
extern void *slab_malloc(size_t num, const char *file, int line);
extern void *slab_realloc(void *addr, size_t num, const char *file, int line);
extern void slab_free(void *addr, const char *file, int line);
#endif
...
void *CRYPTO_realloc(void *str, size_t num, const char *file, int line)
{
    ...
    FAILTEST();
#ifdef USE_SLAB_ALLOCATOR
    ret = slab_realloc(str, num, file, line);
#else
    ret = realloc(str, num);
#endif
