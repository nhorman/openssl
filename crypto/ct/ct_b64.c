...
SCT *
SCT_new_from_base64(unsigned char version, const char *logid_base64, ct_log_entry_type_t entry_type,
 ...
 */
int
CTLOG_new_from_base64_ex(CTLOG **ct_log, const char *pkey_base64, const char *name,
