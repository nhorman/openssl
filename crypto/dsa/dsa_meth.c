...
int
DSA_meth_set_sign(DSA_METHOD *dsam, DSA_SIG *(*sign)(const unsigned char *, int, DSA *))
{
...
int (*DSA_meth_get_mod_exp(const DSA_METHOD *dsam))(DSA *, BIGNUM *, const BIGNUM *, const BIGNUM *,
...
int (*DSA_meth_get_bn_mod_exp(const DSA_METHOD *dsam))(DSA *, BIGNUM *, const BIGNUM *,
...
int (*DSA_meth_get_finish(const DSA_METHOD *dsam))(DSA *) { return dsam->finish; }
...
int (*DSA_meth_get_paramgen(const DSA_METHOD *dsam))(DSA *, int, const unsigned char *, int, int *,
...
int
DSA_meth_set_paramgen(DSA_METHOD *dsam, int (*paramgen)(DSA *, int, const unsigned char *, int,
...
int (*DSA_meth_get_keygen(const DSA_METHOD *dsam))(DSA *) { return dsam->dsa_keygen; }
