 ...
 */
#define OPT_V_ENUM                                                                                 \
    OPT_V__FIRST = 2000, OPT_V_POLICY, OPT_V_PURPOSE, OPT_V_VERIFY_NAME, OPT_V_VERIFY_DEPTH,       \
 ...
 */
#define OPT_X_ENUM                                                                                 \
    OPT_X__FIRST = 1000, OPT_X_KEY, OPT_X_CERT, OPT_X_CHAIN, OPT_X_CHAIN_BUILD, OPT_X_CERTFORM,    \
    OPT_X_KEYFORM, OPT_X__LAST
 ...
 */
#define OPT_S_ENUM                                                                                 \
    OPT_S__FIRST = 3000, OPT_S_NOSSL3, OPT_S_NOTLS1, OPT_S_NOTLS1_1, OPT_S_NOTLS1_2,               \
    OPT_S_NOTLS1_3, OPT_S_BUGS, OPT_S_NO_COMP, OPT_S_NOTICKET, OPT_S_SERVERPREF,                   \
    OPT_S_LEGACYRENEG, OPT_S_CLIENTRENEG, OPT_S_LEGACYCONN, OPT_S_ONRESUMP, OPT_S_NOLEGACYCONN,    \
    OPT_S_ALLOW_NO_DHE_KEX, OPT_S_PREFER_NO_DHE_KEX, OPT_S_PRIORITIZE_CHACHA, OPT_S_STRICT,        \
    OPT_S_SIGALGS, OPT_S_CLIENTSIGALGS, OPT_S_GROUPS, OPT_S_CURVES, OPT_S_NAMEDCURVE,              \
    OPT_S_CIPHER, OPT_S_CIPHERSUITES, OPT_S_RECORD_PADDING, OPT_S_DEBUGBROKE, OPT_S_COMP,          \
    OPT_S_MINPROTO, OPT_S_MAXPROTO, OPT_S_NO_RENEGOTIATION, OPT_S_NO_MIDDLEBOX, OPT_S_NO_ETM,      \
    OPT_S_NO_EMS, OPT_S_NO_TX_CERT_COMP, OPT_S_NO_RX_CERT_COMP, OPT_S__LAST
...
#define IS_NO_PROT_FLAG(o)                                                                         \
    (o == OPT_S_NOSSL3 || o == OPT_S_NOTLS1 || o == OPT_S_NOTLS1_1 || o == OPT_S_NOTLS1_2 ||       \
     o == OPT_S_NOTLS1_3)
...
#define OPT_PROV_ENUM                                                                              \
    OPT_PROV__FIRST = 1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY,         \
    OPT_PROV_PARAM, OPT_PROV__LAST
