...
#   define iosb$w_dev_depend_high                                                                  \
       iosb$r_io_get.iosb$r_io_64.iosb$r_devdepend.iosb$r_bcnt_32.iosb$w_dev_depend_high
...
TerminalSocket(int FunctionCode, int *ReturnSocket)
{
    ...
    */
    ...
    case TERM_SOCK_CREATE:
        ...
        */
        status = sys$qio(EFN$C_ENF, TerminalDeviceChan, IO$_READVBLK, &TerminalDeviceIosb,
                         TerminalDeviceAst, 0, TerminalDeviceBuff, sizeof(TerminalDeviceBuff) - 2,
                         0, 0, 0, 0);
        if (!(status & 1)) {
...
/*----------------------------------------------------------------------------*/
static int
CreateSocketPair(int SocketFamily, int SocketType, int SocketProtocol, int *SocketPair)
{
...
# endif
    ...
    */
    status = sys$qio(EFN$C_ENF, TcpAcceptChan, IO$_ACCESS | IO$M_ACCEPT, &iosb, 0, 0, 0, 0, 0,
                     &TcpDeviceChan, 0, 0);
    if (!(status & 1)) {
...
TerminalDeviceAst(int astparm)
{
    ...
    */
    status =
        sys$qio(EFN$C_ENF, TerminalDeviceChan, IO$_READVBLK, &TerminalDeviceIosb, TerminalDeviceAst,
                0, TerminalDeviceBuff, sizeof(TerminalDeviceBuff) - 1, 0, 0, 0, 0);
